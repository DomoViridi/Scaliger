...
\caption{Tabula characterismi neomeniarum enneadecaeteridis Metonicae}\\
~ &
~ &
...
\begin{rotate}{75}Dies collecti\end{rotate} & 
\begin{rotate}{75}Syzygiae collectae\end{rotate} & 
\multicolumn{2}{l}{\begin{turn}{75}Syzygiae xxx[?]\end{turn}}
\\
\cline{3-31}
\endhead
...
\cline{3-31}
 ...
 \multicolumn{2}{c}{0} &
 \multicolumn{2}{c}{7} & \multicolumn{2}{c}{1} & \multicolumn{2}{c}{3} &
 \multicolumn{2}{c}{4} & \multicolumn{2}{c}{7} & \multicolumn{2}{c}{6} &
  2186  &  74 &  34 \\
\nopagebreak
\cline{3-31}
  &    &

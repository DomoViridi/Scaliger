...
\renewcommand{\arraystretch}{0.970} % Tuned to eliminate Underfull \vbox warnings
%%
\begin{tabular}{@{}c c@{}}
\toprule
\multicolumn{2}{c}{\large\textsc{Laterculus characteris}}\\
\multicolumn{2}{c}{\large\textsc{periodorum Calippi}}\\
\toprule
~ &

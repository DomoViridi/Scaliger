...
%% Required to keep captions normal sized
%\usepackage{caption}
%% Required to rotate the headers over the narrow columns
%\usepackage{rotating}
%%
%% Define fonts 
%\usepackage{fontspec}
...
%\begin{document}
%Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin molestie erat orci, efficitur aliquam tortor accumsan eget. Ut nec tellus nec sem sodales iaculis a vel metus. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Mauris vestibulum lorem ut felis sodales, et varius nunc molestie. Proin condimentum libero id neque porttitor, et commodo ex venenatis. Suspendisse nec auctor lorem. Integer pellentesque scelerisque libero eu bibendum. Donec dictum, dui pretium malesuada tristique, est diam convallis tortor, a ornare neque purus at neque. Interdum et malesuada fames ac ante ipsum primis in faucibus.
%
%% <== Test
%%
\begingroup
...
% Oddly, the folowing row is rendered *shorter* than the rest of the table
%‡ & 88 & 33&Aug & 33&Aug & 33&Oct & 33&Nov & 33&Nov & 33&Dec &
% 8&Ian & 33&Feb & 33&Mar & 33&Mar & 33&Apr & 33&Mai & 33&Iun & 88
%\\
...
\endhead
\\
  & & & \multicolumn{11}{l}{† \textgreek{ἐξαιρεσίμαίων [?]}}
& & & & \multicolumn{11}{l}{‡ \textgreek{δισέξαιρεσιμαίων [?]}}
\endfoot
...
%% Test ==>
%
%Curabitur commodo quam a pellentesque sagittis. Cras luctus, arcu vel elementum iaculis, turpis justo sagittis leo, at efficitur nulla magna vitae justo. Proin elementum urna non nisl imperdiet, eget aliquet augue commodo. Maecenas fringilla odio at ante fermentum varius. Nullam aliquet nec risus sit amet porttitor. Integer enim est, euismod sit amet sapien et, maximus scelerisque nulla. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas viverra elementum tempor. Donec consequat sapien eu convallis bibendum. Phasellus gravida pulvinar justo nec congue.
%\end{document}

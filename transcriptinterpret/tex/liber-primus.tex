...
ut loquuntur.
\lnr{23}Mexicanorum \textgreek{[Greek]} sequitur.
\lnr{23}Quod
...
\lnr{32}Secundum genus est eiusdem sideris at Sole profecti ad eundem
reditus.
...
\lnr{28}In anno Mexicano \textgreek{εἰκοσαήμεροι [?]},
 cum ex \textsc{xviii}.
\lnr{29}mensibus eorum annus constituatur.
\lnr{29}Apud Albanos
...
\lnr{9}Mensis divisio Atticis in \textgreek{[Greek]}.
...
\begin{wrapfigure}[17]{R}{0.5\textwidth}
  \centering
  \includegraphics[scale=0.142857]{M_Aurelius_Agilius}% 1:7 scale
\end{wrapfigure}

% Empty line (new paragraph) needed here to make sure the image is placed
% here and the text flows around it. See Issue #1.
\lnr{25}Martialis:
...
\lnr{6}Annus Sxonicus geminum Giuli, et geminum Lida.
\lnr{6}Sed in
...
Lunae describebat:
\lnr{2}sed incertis neomeniis, quae non produent ex observatione
...
constituerent.
\lnr{7}Quod genus longe desciscebat at modo anni
Lunaris.
...
\lnr{13}Prior forma in Graecia resedit: altera in Oriente.
...
\lnr{23}Eiusque mensis primus duantxat
...
\lnr{28}Syzygiae autem novem et nonginta.
\lnr{28}Octaeteridum
...
\lnr{31}Et Kelendae Februarii ordinarii in anno embolimaeo nunc in Regisugium,
nunc in Terminalia, incurrebant.
\lnr{32}Neque enim semper inter
Terminalia, et Regifugium intercalabantur, ut vult Censorinus.
\lnr{34}Quia hoc pacto Februarius ordinarius nunc viginti octo; nunc undetricenum
dierum fuisset.
\lnr{35}Quod tamen salsum ex Varrone conuicitur.
...
\lnr{20}Ideo at nobis \textgreek{[Greek]} vocabitur.
...
nesciebant.
\lnr{11}Praeterea at mensibus superfluis, qui sunt maiores tricenis
...
\lnr{32}Tartari hodi inter ultimam Ianuarii,
...
\lnr{24}Quare ut epochat suas seruarent illi veteres,

...
\lnr{37}Nam \textsc{viii} iulii \textgreek{[Greek]} tunc
erat in octava parta Cancri.
\lnr{38}Primus igitur agon Olympicus celebratus
\textsc{xxiii} Iulii.
\lnr{39}Et omnes Graeci \textgreek{[Greek]} collocant in \textsc{viii}
 aut \textsc{ix}
...
% 38
% {PDF page nr}{source page nr}{line nr}
\plnr{121}{38}{3}Construatur igitur Tabula primi mensis Elidensium in annis totius periodi
...
%\tiny
\centering
\input{./tables/neomenia_elidensis}
...
\lnr{11}Ideo quartus anus Olympicus Solaris
...
diebus tribus.
\lnr{18}Annus sequens cum 392 facit dies 754. qui de duobus
...
\lnr{11}Itaquew conveniet Attica cum Olympica cyclo, non tempore: quod
...
\lnr{41}Unde \textgreek{[Greek]} dixit Pindarus
Olympico \textsc{v}.
...
Graeci.
\lnr{14}Cum igitur de Anno Attico disputaremus, \textgreek{[Greek]} duas
...
ratiocinia.
\lnr{35}Nam quod de circulo proposuimas, id omnino dissimile
...
\lnr{27}Ergo Posideon habuit \textgreek{[Greek]}, et
consequenter Gamelion proximus ab eo guit mensis primus in ratione
Tetraeteridis priscae.
\lnr{29}Cum igitur Posideon habuerit \textgreek{[Greek]},
...
% 44
% {PDF page nr}{source page nr}{line nr}
\plnr{127}{44}{1}Adiecimus etiam \textgreek{[Greek]}:
...
Olympicae sextae.
\lnr{6}De quibus si accomodata integra periodo,
(ut fieri oportet; quoties maior numerus est, qui dedtrahitur, quam unde
...
\lnr{13}Eum
annum dicit Dionysius habuisse \textgreek{[Greek]}.
\lnr{14}Sed sine dubio
aut ille fallitur, aut codex est mendosus, ubi est \textgreek{[Greek]}, pro
\textgreek{[Greek]}.
...
anni navali certamine ad Slamina.
...
\textgreek{[Greek]}, anno quarto desinente Olympiadis 86,
scito, ut suo loco declarabitur, libro secundo, Metonem novilunium
anticipasse.

% 46
% {PDF page nr}{source page nr}{line nr}
\plnr{129}{46}{4}Nullus enim \textgreek{[Greek]} potest habere novilunium in

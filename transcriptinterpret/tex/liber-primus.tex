...
\lnr{31}\emph{Siquidem} \textsc{ccclx} \emph{statuere,
...
\textgreek{[Greek]}.
\lnr{11}Diodorus Siculus libro \textsc{xii} scribit Metonem astronomum
...
dierum.
\lnr{23}Incipiat igitur primus annus ab novilunio, quod incidit in \textsc{xix}
% à -> ab
Iulii, feria prima, cyclo Solis, exempli gratia,
 \textsc{xxv}, cum litera dominicalis
est D.
\lnr{25}Sane quintus annus incipiet ab \textsc{xxviii} Iunii, feria sexta, cyclo Solis
% à -> ab
primo, cum litera dominicalis est F.
\lnr{26}Nam 1440 dies per \textsc{vii} divisi,
...
faciet feriam sextam, characterem anni quinti, ut diximus, in
 \textsc{xxviii} Iunii.
\lnr{29}A qua die ad \textsc{v} Iulii, ubi est novilunium posterius,
 intervallum est
...
triginta et duos.
\lnr{32}Sed cum sit \textgreek{ὲξαίρεσις [?]}, habet tantum \textsc{xxxi}.
\lnr{32}Atqui
...
\lnr{15}Differentia dies \textsc{xiiii}.
\lnr{16}Esto novilunium in \textsc{xx} Martii, quando epactae sunt \textsc{xi}.
\lnr{16}Post quartum
annum epactae erunt \textsc{xxv}.
\lnr{17}Novilunium \textsc{vi} Martii.
\lnr{17}Differentia
...
\lnr{7}Idem libro \textsc{iiii}. 46. \textgreek{[Greek]}
...
confert Gaza.
\lnr{21}Item Demosthenes Olynth. \textsc{iii}: \textgreek{[Greek]}.
...
\lnr{30}A \textsc{xviiii} Iulii, ad \textsc{xvi} Octobris, sunt
...
\lnr{4}Sed \textsc{xix} Tetraeterides Graecae, cum novem mensibus
...
129.
\lnr{10}Illis 129. in 76 annos distributis, omnes \textsc{xix}
...
\lnr{37}Nam \textsc{viii} Iulii \textgreek{πλατθκως [?]} tunc
...
Iulii.
\lnr{40}Imo Ephorus apud Dionysium Halicarnassensem, \textsc{ix} Iulii vocat
...
duos cum 7/76. quartus unum cum 60/76.
...
\lnr{33}Sic progressus diei 1 53/76 ostendet tibi quintam Tetraeterida,
...
\textgreek{πρυτανείας [?]}.
\lnr{40}Ab undecima autem mensis ad \textsc{xvi} per quinque
...
\lnr{12}Is ait Ilion captum \textsc{xvii} diebus
...
anni 3386.
\lnr{6}Cuius character 5.14.55. Septembris \textsc{xxiii}, feria quinta,
Cyclo Solis 26.
\lnr{7}Ideo plenilunium \textsc{vii} Octobris, feria quinta, ut
erat propositum.
...
\lnr{18}Ideo \textsc{xxiii} Thargelionis congruebat vicesimae
secundae Iunii, ab qua ad \textsc{ix} Iulii, non \textsc{xvii},
% à -> ab
 ut vult Dionysius,
sed \textsc{xvi} tantum dies erant.
\lnr{20}Nisi forte ipse \textsc{ix} non autem \textsc{viii} iulii
...
\lnr{6}Sed in \textsc{xv} aut \textsc{xiiii} Scirrophorionis potest
 novilunium committi.
...
\lnr{9}Schirrhophorion \textsc{iii} Iulii.
\lnr{9}Ab Iudaicus
...
\subsection{De Periodo Macedonica Aestiva}
...
\begin{table}[htbp]
\centering
\input{./tables/047_menses_macedonum}
...
\lnr{23}Et propterea primus caepit a cyclo \textsc{xiii}: et consequenter
...
\begin{table}[htbp]
\centering
\input{./tables/050_menses_alexandreae}
...
\lnr{20}Anno a Nabonassaro 840, Tybi \textsc{ii} absoluto, Agrippa astrologus
...
\begin{table}[htbp]
\centering
\input{./tables/050_menses_bithyniorum}
\caption{Menses Bithyniorum}
\label{tab:menses_bithyniorum}
\end{table}
\lnr{23}Tempus, \textsc{xxix} Novembris, anno
Christi vulgari 92:
...
\lnr{6}Quare recte
apud Eusebium anno \textsc{iii} Olympiadis 49 prima pythias attribuitur.
\lnr{8}Cui adstipulatur Scholiastes priscus Pindari in Pythionicarum
\textsc{iii}. \textgreek{καθίστατο δὲ[?]}, inquit,
 \textgreek{[Greek]}.
...
\lnr{14}Rursus idem Scholiastes \textsc{xii} Olympico: \textgreek{[Greek]}.
\lnr{16}Ergo Pythias celebrata 49. Olymp.[?]
\lnr{16}Idem
Scholiastes \textgreek{εἴδει[?]} Pythionicarum \textsc{xiiii}.
\lnr{17}\textgreek{[Greek]}
...
Thargelion dicitur.
\lnr{28}Nam \textgreek{[Greek]} Apallinem natum volunt.
...
tertio Iphiti, cyclo Lunae \textsc{vii},
 Solis \textsc{xx}, tempore veris praecipitati.
\lnr{34}Pindarus Olympionicarum \textsc{xiii}.
\lnr{34}\textgreek{[Greek]}.
\lnr{35}Manifesto inniuit eodem
...
nisi fote dicamus aliud solenne Atticum hic intelligi.
...
\textsc{xv} mensis, plenilunio.
\lnr{3}Atque haec quidem dies unica erat prisco solenni
dedicata.
\lnr{4}Sed postquam proposita fuerunt praemia faltus, disci,
...
in \textsc{xv}, quae, ut diximus, erat  plenilunium, Postridie autem, hoc
...
\textgreek{τῇ ἕκτῃ τὴς σελήνης[?]}, ut Herculem \textgreek{τῇ τετράδι[?]} natum,
 verisimile est periodam
coepisse avere adulto: hoc est a mense secondo verno, eumque
...
\lnr{38}Quinquennium est intervallum qunque annorum solidorum: quinquennale
...
\textgreek{[Greek]}
\end{quote}
Manifesto vocat \textgreek{τετελεσμένον ὀνιαυτὸν[?]} ver adultum,
...
% 55
% {PDF page nr}{source page nr}{line nr}
\plnr{138}{55}{1}Plutarchus Pelopida: \textgreek{[Greek]}.
\lnr{4}Quare, ut dixi, ibi erant \textgreek{[Greek]},
ut Athenis fine Posideonis.
\lnr{5}Cur enim alibi, si mensis sequens
est initium anni?
\lnr{6}Primus mensis dicebatur \textgreek{Βουκάπος[?]}, respondens
Gamelioni Attico.
\lnr{7}Plutarchus ibidem: \textgreek{[Greek]}.
\lnr{8}Hunc
autem eundem, quem Hesiodus \textgreek{ληναιῶνα[?]} vocat,
 esse putat Plutarchus.
Hesychius, \textgreek{ηναιών[?]}.
\lnr{10}\textgreek{[Greek]}.
\lnr{11}\textgreek{καὶ γὰρ φυχρός ὲστιν[?]}, etcetera.
\lnr{11}Secundus mensis
erat \textgreek{Ερμαῖος[?]}.
\lnr{12}Sequitur apud Hesychium: \textgreek{[Greek]}.
\lnr{13}\textgreek{[Greek]}.
...
νεμος[?]},
Atheniensibus \textgreek{Εκατομβαιῶνος ἱσταμένου τῇ πέμπτῃ[?]}.
...
\lnr{23}Erat annus secundus Olympiadis \textsc{lxxv}, et
proinde 298 Iphiteus, periodi Atticae 32: cuius Boedromion \textsc{xvii}
...
\lnr{30}Boedromion illius anni \textsc{xvii} Septembris,
 et propterea \textgreek{ἡ τετρὰς[?]}, habita
ratione \textgreek{τὴς ὲξαιρἐσεως[?]}, hoc est, \textgreek{ἡ τρίτη[?]},
 \textsc{xix} Septembris.
\lnr{21}Ergo, cum
\textsc{xix} Septembris fuerit \textsc{xxvii} Panemi Thebani, Neomenia Panemi
congruit vicesimae quartae Augusti.
\lnr{33}Et proinde \textsc{xxv} Iulii fuerit
neomenia mensis primi aestivi, quem Plutarchus dicit Hippodromion
a Thebanis nominari.
\lnr{35}Sed bis tantum mensis aestivi caput in
periodo Olympica incidit in \textsc{xxv} Iulii, nempe anno trigesimo nono,
...
secundi anni Olympiadis 102 ita scribit: \textgreek{τοῦ το μὲν συνέβη Βοιωτοῖς
...
\subsection{De Periodo Syracusana}
...
obiecit.
\lnr{12}Polybius Excerptis libri \textsc{ix}.
\lnr{12}\textgreek{[Greek]}, etcetera.
...
excogitari potuit.
\lnr{3}Propter utilitatem periodi et sphaerae \textgreek{[Greek]}, in memoriam
...
sed et ignoratus ciuibus fuis esset.
...
\begin{quote}
  ...
  \emph{Tempora quae messor, quae currus arator haberet?}
...
scribens \textgreek{τὰς απονδὰς πεντηκοντούτεις[?]} initas fuisse, \textgreek{Πλειστόλα Σπάρτης
ἐφορεύοντος, Αρτεμισίου τετράδι φθίνοντος, Αλκαίου δὲ Αθήνῃσιν ἄρχοντος,
 Ελαφηβολιῶνος
ἕκτῃ φθἰνοντος[?]}.
\lnr{34}Erat annus \textsc{li} periodi Olympicae, \textsc{xiii} Atticae.
\lnr{35}A periodo Olympica aufer 12.
\lnr{35}Erat enim annus 39 periodi Laconicae.
\lnr{36}Elaphebolion \textsc{xxv} martii.
\lnr{36}Ergo Artemisius Laconicus \textsc{xxiii} Martii.
...
\plnr{141}{58}{2}Ergo annus Tetraeteridis Laconicae idem fuit cum
 anno Olympicae:
ac proinde 12 addenda annis periodi Olympicae, ut habeas annum Laconicum.
...
\end{quote}
% Euripides, Alcestis, line 445-451
...
\subsection{Periodus Samiorum, et aliarum Graeciae civitatium}
...
post observationem silstitii a Metone et Euctemone factam,
anno Iphiteo currente 496.
\lnr{26}Et propterea cum fuerit ultimus Olympiadis
184[?], et post mensem incipere debuerit Olympias 125, non est
...
ille menses Calippicos \textgreek{κατὰ σελήνην[?]},
...
δύο[?]}.
\lnr{7}Sed et idem in \textsc{v}. manifeste id docet:
...
\subsection{De anno commentitio Herodoti}
...
\textgreek{οὖν μῆνας τριακονθημέροις ἦγον, οὖν δ᾽[?] ἐμβολίμους παρ᾽ ἐνιαυτόν[?]}.

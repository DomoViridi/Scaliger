...
%
\begin{table}[p]
  \input{./tables/006-convertendi-ostenta}
\end{table}
%
\lnr{14}Nam ante
...
% Insert table
\begin{table}[tbp]
  \input{./tables/008-dies-hebdomadis}
\end{table}
...
\begin{table}[htbp]
\input{./tables/033-mensium-atticorum}
\end{table}
%
...
\begin{table}[htbp]
  \input{./tables/034-neomeniarum-lunarium}
\end{table}
...
\begin{table}[htbp]
 \input{./tables/038-neomenia-elidensis}
\end{table}
%
...
\input{tables/043-neomeniarum-atticarum}
%
% 44
% {PDF page nr}{source page nr}{line nr}
...
\begin{table}[hbtp]
  \input{./tables/048-menses-macedonum}
\end{table}
\lnr{6}Cum
...
\begin{table}[htbp]
  \input{./tables/050a-menses-alexandreae}
\end{table}
...
\begin{table}[htbp]
  \input{./tables/050b-menses-bithyniorum}
\end{table}

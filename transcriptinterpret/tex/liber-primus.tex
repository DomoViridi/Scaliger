...
\input{./tables/convertendi_ostenta}
...
die.
\lnr{18}Qui cum habeat appendices \textgreek{τὰς ὑπερβαλλούσας δὺο [?]}, aufert ab primo
% à -> ab
...
cum Solis rationibus congruit, sed potius duae: quidem iunctae
...
cum Sole congrueret.
\lnr{13}Atqui id intra Tetraeterida contigere non potest,
...
\lnr{23}Ita
fere semper mensem civilem plenum alternis Traeteridibus intercalabant.
...
quorum viginti octo erant embolimaei, caparavit:
\lnr{30}Idque
...
\lnr{5}Utrumque
enim falsum convincit priscorum fcriptorum auctoritas, et quod Anthesterion
...
\lnr{20}Fuisse autem annua docet Demothenes
...
\lnr{20}Gazae enim
quartis ab Hecatombaeone est Maemacterion, quintus Pyanepsio, sextus
Anthesterion.
...
\textgreek{[Greek]}, spatium aliquod intersse innuit Theopharstus
...
% à -> ab
abfuisse, et in Novembrem conuenisse.
...
\textgreek{[Greek]}, observuavit Lunam coniunctam Spicae Virginis.
\lnr{28}Quod tempus convenit diei octavae novembris.
\lnr{28}Proinde Neomenia
Pyanepsionis Calippici \textsc{xvii} Octobris.
...
%% Insert table: Laterculum mensium Atticorum secundum anni quadrantes.
\begin{table}[htbp]
\centering
\input{./tables/mensium_atticorum}
...
\lnr{1}Res ipsa, et
actus, \textgreek{[Greek]}. \textgreek{[Greek]} Atheniensium erat Posideon.
\lnr{2}Id nos
...
% Insert table: Laterculum neomeniarum lunarium in mensibus Atticis
\begin{table}[htbp]
\centering
\input{./tables/neomeniarum_lunarium}
...
\lnr{24}Sed caussa
\textgreek{[Greek]}, quam ille reddit, tam ridicula, quam falsum, quod subiicit,
...
\lnr{40}Attici, cum omnes fuerint \textgreek{[Greek]},
 ii in tres \textgreek{[Greek]} dividebantur.
...
diebus 1448, vel, si embolismus incderet, in diebus 1478, una dies detrahenda
erat, ut annus sequens rediret ingratiam cum Luna, quod
...
sed biduum eximeretur, idque uqater in illis 76 annis fieri solebat.
\lnr{18}Quod
iam ostendimus, et locus Ciceronis ex Verrinis id clare testatur.
\lnr{19}Sed
puto Plutarchum sentire, quando fit \textgreek{[Greek]},
 eam semper \textgreek{[Greek]}
\textgreek{[Greek]} fieri, non alio mense.
...
pleni essent, et cavi, omnes tamen \textgreek{[Greek]} habebant.
\lnr{29}Et propterea
alternis unus dies eximebatur, ut secunda secundi mensis non
 \textgreek{[Greek]},
sed \textgreek{[Greek]} vocaretur.
...
\textgreek{[Greek]} putabantur: hoc est \textgreek{[Greek]} habebant.
\lnr{37}Milites autem
quot mensibus stupendium accipiebant ratione triginta dierum etiam
mense cavo.
...
\textgreek{[Greek]}, in qua pro secunda mensis tertiam putabant, 29 dies tantum
...
\lnr{16}Annus enim
Solistantum est, menses Lunae, dies utriusque sideris.
\lnr{17}Visum igitur
...
\lnr{33}Isque annus, in que hoc accidebat,
vocatur ab nobis \textgreek{[Greek]}.
% à -> ab

...
% 23
% {PDF page nr}{source page nr}{line nr}
\plnr{106}{23}{5}Is igitur ut probet menses Graecorum
...
viri sententia: et dieas vicesies quinquies mille ac ducentos per septuaginta
annos partiamur.
...
cnfectum est plenilunium, sane sexta, hoc est \textgreek{[Greek]},
fuit novilunium.
...
\lnr{18}Certis tamen temorum
epochis alligatos fuisse, neque temere n anteriora evagari solitos,
...
Graecifines tuertur, ut quidem aliquam fuisse necessario statuendum
...
faciet feriam sextam, characterem anni quinti, ut diximus, in
 \textsc{xxviii} Iunii.
\lnr{29}A qua die ad \textsc{v} Iulii, ubi est novilunium posterius, intervallum est
...
\lnr{32}Minime.
\lnr{32}Sed conditor
Tetraeteridis Graecae duos dies in sine annorum singulorum appendices
...
\lnr{10}Illae
vero dies duae in calcem anni reictae dicebantur \textgreek{[Greek]},
 vel \textgreek{[Greek]}
...
\textgreek{[Greek]}: quia scilicet per illud biduum Attica esset sine legitimis
magistratibus.
\lnr{15}Atqui videmur nostri obliti.
\lnr{15}Binos enim dies contulimus
in exitum anni, qui in sine Tetraeteridis sivunt octo: cum tamen
...
\lnr{21}Propterea
dies, quae eximebatur, vocata \textgreek{[Greek]}.
\lnr{22}Cicero in Verrem: \emph{Est
consuetudo Siculorum, caterorumque Graecorum, quod suos dies mensesque
congruere volunt cum Solis Lunaeque rationibus, ut vonnunquam, siquid
...
\lnr{27}Haec Marus Tullius.
\lnr{27}Quae tum demum
locum habent, si \textgreek{[Greek]} fit in mense eodem, qui habet biduum illud
adiectitium.
\lnr{29}Nam si mensis idem habet \textgreek{[Greek]}, et in eodem
fiat \textgreek{[Greek]}, in omni Tetraetiride mensis ultimus quatri anni
 habebit
unum et triginta dies tantum: cum tamen in aliis annis idem mensis habuerit
triginta et duos.
\lnr{32}Sed cum sit \textgreek{[Greek]}, habet tantum \textsc{xxxi}.
\lnr{32}Atqui
in anno Attico alii mensi competebat \textgreek{[Greek]}, alii
 \textgreek{[Greek]}, ut postea suo loco delarabitur.
\lnr{34}Videmus tamen Ciceronem velle in Tetraeride
Syracusana ultimo mensi competere \textgreek{[Greek]}, \textgreek{[Greek]}
\textgreek{[Greek]}.
...
esse tantum dierum \textsc{ccclix}, praeter \textgreek{[Greek]}.
\lnr{39}Itaque in anno
\textgreek{[Greek]} una tribus \textsc{xxxv} tantum dies imperabat.
\lnr{40}Hoc plane est,
quod dixit Harpocratio, \textgreek{[Greek]} esse tantum
...
biduo propter \textgreek{[Greek]}, five \textgreek{[Greek]}.
\lnr{16}Verbi gratia:
duodecimus mensis anni primi habet terminum novilunii in \textsc{xxvi}
die.
\lnr{18}Qui cum habeat appendices \textgreek{[Greek]}, aufert ab primo
% à -> ab
...
secundi anni propter \textgreek{[Greek]} proxime
 \textgreek{[Greek]} praecedentes et unum
...
\textgreek{[Greek]}, et in \textgreek{[Greek]}: quae vere si qua alia,
\textgreek{[Greek]} vocari potest: ut vides in Tabella, ex qua
...
% 27
% {PDF page nr}{source page nr}{line nr}
\plnr{110}{27}{1}Quod ne veteres quidem explicarunt.

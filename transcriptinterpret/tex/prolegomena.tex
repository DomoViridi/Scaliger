...
\begin{quote}
\begin{greek}
\lnr{18}ἔςαι δ᾽ αὖθις ἀνὴρ, ἢ χοίραντος, ἠὲ τύρανντος,\\
...
\plnr{VIII}{1}Docemus praeterea, unde
...
\plnr{IX}{3}Quarta pars agit de vera emendatione anni, et
...
\lnr{33}Primo computatione non recta annorum \textsc{lxx} a capto Sedekia.
...
\lnr{17}Ponamus \textsc{xiiii} annum Ezekiae in
...
\lnr{27}Auctor Isaias \textsc{xxxvii}, 30.
...
\plnr{XI}{1}Additis 907 annis absolutis ab Exodo,
...
\lnr{35}Quis unquam a libro reperto vllam aeram, aut edicto Iosiae institutam, aut a
...
\lnr{39}Capite \textsc{xxv}, quare dicit
...
\plnr{XII}{1}Certe mos est uti epocha, quae omnibus et nota et in usu sut.
\lnr{1}Quare
...
\lnr{15}Sed quae haec plumbea Iudaeorum sententia a \textsc{xviii} Iosiae
Iubileum putare?
\lnr{16}Iubilea putantur a primo anno hebdomadis, non
a septimo.
\lnr{17}At \textsc{xviii} Iosiae suit septimus septimanae, non primus.
...
\pnr{p. XIII [pdf 40]}
%\begin{parnumbers}
\lnr{42}Nam \textsc{xxix} solidos annos imperauit,
teste Beroso.

\plnr{XIII}{1}Quod si filius eius anno \textsc{xxx} partis iam duodecimum
...
\pnr{p. XIV [pdf 41]}
%\begin{parnumbers}
\lnr{41}Vnde etiam sequitur, mortuo Nabopollassaro, non tricesimum annum Nabuchodonosori
dici caeptum in Chaldaea, sed primum quae res obseruatione
digna.

\plnr{XIV}{3}Iudaei primum annum putarunt ab eo tempore, quo
...
\lnr{11}Proinde annus ille erat \textsc{xiiii} Nabuchodonosori in Syria, secundus
...
\lnr{15}His tam illustribus demonstrationibus sua somnia praeserant, quibus antiquius
...
\plnr{XV}{1}Quis aliter potest demonstrare?
...
\plnr{XVI}{1}Neque solum plenilunio, sed etiam eodem anno, quo
Olympia.
\lnr{2}Itaque Herodotus libro \textsc{viii} Olympia et Karnia anno primo
...
\plnr{XVII}{1}Itaque eius decessus confirmatur primum accurata putatione
...
\lnr{4}Qui stupor non meret castigationem, cum tanquam sorex indicio suo perierit.
...
\plnr{XVIII}{1}Nam initio Diocletiani perperam sumpto, perperam quoque
...
erat Christi 1593.
\lnr{12}Epocha igitur Martyrum iniuit \textsc{xxix} Augusti,
...
\lnr{35}Nam cum constet passos \textsc{iii} Kal. Septembris, et ita habeat
...
\plnr{XIX}{3}Unde factum, ut ap initio operis,
...
sexta, nascente luce.}
\lnr{29}Passi ergo sunt anno 403, cyclo Solis \textsc{xx}, quando
...
\plnr{XX}{1}Multa igitur peccari necesse est
...
\lnr{27}Nam obiit \textsc{xxv} Iulii, \textsc{lxi} diebus ante
...
\plnr{XXI}{2}Olympias enim illa Iphitea caepit ex diebus aestiuis
...
\plnr{XXII}{1}Sunt enim ii, qui Caelicolae
vocantur.
...
\lnr{27}Baptizatus est anno \textsc{xv} Tiberii, duobus Geminis
 \textsc{coss}. anno Iuliano 74.
\lnr{29}Ergo \textsc{xxv} Decembris anni 73 illi inibat annus
 primus a tricesimo.
...
\textsc{xv} Tiberii.
\lnr{36}Quem enim putat \textsc{xv}, is est \textsc{xvi}, et magno errore illi
...
\plnr{XXIII}{2}Nam is fuerit annus 75 Iulianus iniens.
...
\lnr{16}Apud Gregorium Turonensem libro \textsc{vi},
...
\plnr{XXVI}{1}Sed valeant Sabbata praepostera.
...
aliter \texthebrew{[Hebrew]}, quas \textgreek{[Greek]} quoque vocarunt
 ...
 cum \textsc{xxi} Nisan.
\lnr{38}\textsc{vi} Sivvan,
id est, \textgreek{[Greek]}.
\lnr{39}\textsc{xv} Tisri, id est, \textgreek{[Greek]}, cum
 \textsc{xxii} Tisri.
%\end{parnumbers}
%\clearpage
\pnr{p. XXVII [pdf 54]}
...
\plnr{XXVII}{1}\textit{Et Sabbatum magnum in renovatione Luna a Iudaeis
...
\lnr{28}Si quintadecima Nisan, quando Christus passus, fuit feria sexta: ergo Pentecoste
...
vetat opus facere.
\lnr{37}Exodi \textsc{xii}, 16.
\lnr{37}Levitici \textsc{xxiii}, 7.
\lnr{37}Hinc quoque
...
\plnr{XXVIII}{2}Si enim Sol nondum occidit, est Sabbatum,
...
esse Sabbatum.
\lnr{12}Ergo hoc modo oportebat omnem \textsc{xvi}
...
\pnr{p. XXIX [pdf 56]}
%\begin{parnumbers}
\lnr{41}Nam Christus passus cyclo \textsc{xv} Lunae, \textsc{xiiii} Solis,
 tertia Aprilis,
...
\plnr{XXIX}{6}Atque hactenus quidem de
...
\lnr{23}Audite
ergo \textgreek{[Greek]}.
\lnr{24}Annus capti Iechoniae est \textsc{xxvi} Nabopollassari,
...
quaest.
\lnr{21}Danielis \textsc{vii} annis minus diximus.
...
\lnr{19}Initio \textsc{vi} capitis ita legimus:
 \textit{Darius Medus accepit regnum}.
\lnr{19}Et initio \textsc{xi}: \textit{Primo autem anno Darii Medi}.
...
\plnr{XXXIII}{7}Nam et ipse Assuerus,
...
creatum esse.
\lnr{29}Itaque initio capitis \textsc{vi}, statim post caedem Balsasari,
...
\plnr{XXXIV}{2}Neriglissororus cum quatuor annos regnasset,
...
administrasse.
\lnr{15}Sane Ieremias cap. \textsc{xxvii}, 7, dixit omnes gentes subiectas
...
est Balsasar.
\lnr{20}Cui succedit Nabonidus, qui cum annos \textsc{xvii} regnasset,
...
\lnr{34}Hunc Cyrus anno \textsc{xvii}
ipsius Darii, praelio victum, in arcem Borsippenam compulit.
\lnr{35}Interea ipse Cyrus Babylone potitus anno imperii sui \textsc{xix}, aliquod
...
\plnr{XXXV}{2}Itaque pacatis Orientis partibus Babylonem rediens, Susianam omnem iugum
...
\lnr{21}Cap. \textsc{xxv}, 12. \textsc{xxvii}, 7. \textsc{xxix}, 10.
...
\lnr{24}Esdrae \textsc{i}, 1.
\lnr{25}\textsc{vi}, 3.
\lnr{25}Et tertii anni mentio est Danielis \textsc{x}, 1: qui ei fuit
 ultimus et
vitae et imperii.
...
189 Nabonassari.
\lnr{30}Obiit igitur anno \textsc{xxxi} labente imperii sui Persici,
...
\plnr{XXXVI}{1}\texthebrew{[Hebrew]} enim verbum, quo utitur Daniel,
...
\lnr{5}Sic accipiendum \textsc{i}.
\lnr{6}Reg. \textsc{xi}, 31.
...
\pnr{p. XXXVII [pdf 64]}
%\begin{parnumbers}
\lnr{41}Imo multa eiuscemodi regna sub uno Principe contrariis legibus videmus regi.

\plnr{XXXVII}{2}Nostros vero disputatores fugit res pulcherrima, haec contigisse
...
\lnr{19}Daniel vero sub Cyro adhuc praefectus erat Susidis. \textsc{x}, 4.
\lnr{19}Fluvius
...
duodecim.
\lnr{12}Huic succedens frater \textgreek{[Greek]}, \texthebrew{[Hebrew]} annos novem.
...
\lnr{29}Apud Tertullianum Apologetico, cap. \textsc{xix}.
...
Ithobaalis.
\lnr{40}Inivit igitur regnum \textsc{xviii} annis ante quam gener eius
...
\plnr{XXXIX}{6}Praeterea hinc colligitur intervallum
...
\lnr{32}Haec Tyri expugnatio ab Ieremia praedicta fuerat cap. \textsc{xlvii}, 4.
\lnr{33}Sed iterum
Tyrus rebellavit, et capta ab eodem Nabuchodonosoro post
excidium Templi.
\lnr{35}Ezekiel \textsc{xxvi}. cuius annum ignoramus.
\lnr{35}Apud
...
\plnr{XL}{2}Nam et Dido \texthebrew{[Hebrew]} est \textgreek{[Greek]},
 quo nutrices
...
\plnr{XLI}{1}De Persarum Regibus, quomodo illi ex Daniele,
...
\lnr{18}Ergo Assuerus, sive, ut pronunciari debet, Oxyares, est Xerxes, ditissimus
regum Persidis.
\lnr{19}Daniel \textsc{xi}, 2.
...
culpa fuerit?
\lnr{35}Ecce \textsc{xxxvii} annis post emissum a Dario Notho edictum
...
\plnr{XLII}{2}A Cyri anno primo, ad ultimum Darii, opus
templi disturbatum.
\lnr{3}Esdrae \textsc{iiii}, 5.
...
adduxerunt.
\lnr{8}Esdrae \textsc{iiii}, 6, 7, 11, 12, 13, et sequentibus.
\lnr{8}Qua de re
...
% Zehariah 1:12
\lnr{12}En disturbatio septuaginta annorum.[?] cui loco hostes veritatis contradicere
non possunt.
...
\plnr{XLIII}{2}Sed satis eum refellunt quae superius, et libro
...
\lnr{32}Nehem. \textsc{xiii}. 28.
\lnr{32}Ille vocabatur
Manasses, illa Nicaso.
\lnr{33}Ioseph. \textsc{xi}, 7.
...
\plnr{XLIV}{1}Quid enim volunt illa?
...
ostendit.
\lnr{9}Sed et initium ostendit: \textsc{ix}, 25.
...
\lnr{16}Atqui ex usu Hebraismi nos tandem perceptimus esse extra illas septuaginta:
...
\plnr{XLV}{1}Nehemiae \textsc{i}, 7, 8, 9.
% Nehemias I:7-9:
...
\lnr{5}Ergo non a \textsc{xx} anno Artaxerxis.
...
se traduxisset.
\lnr{30}Nam \textsc{vii} anno missus Esdras in Palaestinam.
...
\lnr{36}Esdrae \textsc{iiii}, 12, 13.
...
\plnr{XLVI}{1}Si nostras cum horum
...
\lnr{16}Invidos, zelotypos, \textgreek{[Greek]}, cum suis paradoxis valere iubemus.
...
\end{quote}
\lnr{3}\textgreek{[Greek]}, (ut id quoque explicem) est Ostanes rex Babylonis.
...
\textgreek{[Greek]}, \textgreek{[Greek]}.
\end{quote}
\lnr{10}Nam diserte intelligit, si neomenia \textgreek{[Greek]} inciderit in diem
...
\lnr{15}Praeterea damnavimus sententiam nostram de Tekupharum sede, quas in prisca
...
\lnr{17}Itaque propter tam subtile epichirema \textgreek{[Greek]}, \textgreek{[Greek]}.
...
\plnr{XLIV}{3}Nos hoc opus non ulla ambitione
...
\plnr{L}{3}Ubi deerunt characteres,
...
\lnr{23}Sic Matthaei \textsc{xvii}, 1.
...
\plnr{LI}{1}Aliquando etiam caliginem Solis defectum putant:
...
\plnr{LII}{2}Olympiadem quanque signet sua die,

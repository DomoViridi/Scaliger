...
Iudaicus.
\lnr{14}Caussa est, quod in annis Arabicis 1690, tot \myfrac{82}{1080} omituntur
...
\lnr{30}Quod sane mitum est: cum
...
\lnr{35}Sed anni
illi, quorum primi character est, 5, 14, 586, quinque per adiectionem
...
\lnr{11}Graeci autem \texthebrew{[?]}[Hebrew], Babylonii:
 qui antiguitus a Ptolemaeo Lago
...
vetere: addeo ut puaci inter illos Hebraice scirent.
...
Magistrorum scita aversantur, alii legem tantum aplectuntur,
...
Lunarionibus, in cyclis 8, 19, ut diximus.
...
\textgreek{[Greek]} gloriari solitos se compertum habere ex

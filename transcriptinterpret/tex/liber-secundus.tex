...
in quo antea deprehendebantur, et quandiu Octaeteridis
fides suspecta non fuit, eam esse mensuram \textgreek{[Greek]}
...
\end{quote}
\lnr{19}Innuit, ut vides, de ortu et occasu \textgreek{[Greek]} annuo.
\lnr{19}Nam si qua
est varietas, eius \textgreek{[Greek]}, quantocunque tempore illa reditura
sit; omittit dicere.
\lnr{21}Subiicit:
\begin{quote}
...
\begin{quote}
  ...
  Ocius in sedes, momentaque prisca reducit.
\end{quote}
Putat \textgreek{[Greek]} inerrantium fieri, ita ut sidera, ut ipse loquitur, in
...
diem, et horam, in qua antea fixit.
...
% 74
% {PDF page nr}{source page nr}{line nr}
\plnr{157}{74}{2}Et veram \textgreek{[Greek]} intra \textgreek{[Greek]}
fieri.
\lnr{3}De hallucinatione Festi super nomine Enneaeteridos, supra
dictum est.
\lnr{4}Aratus quoque volens ostendere omnium inerrantium
\textgreek{[Greek]} Solem ipsum esse, absurde quidem, sed tamen eius
rei causam confert ad cyclum Metonis.
\lnr{6}Quo intervallo, \textgreek{[Greek]}
fiat restitutio, orbit et conversio quaedam
mundi universalis.
...
esse mirum not est, cum Hipparchus, et post eum Astronomiae
...
\lnr{16}Apertius vero Diadorus Siculus docet illos veteres, \textgreek{[Greek]}
illis novemdecim annis vertentibus, putasse.
\lnr{17}Libro
enim duodecimo de illis novemdecim annis loquens ita scribit;
\textgreek{[Greek]}
\lnr{20}\textgreek{διὸ [Greek]}
\lnr{22}\textgreek{τὰ [Greek]}
\lnr{23}\textgreek{διὸ μέχρι [Greek]}
\lnr{25}Quid melius potuit versus Arateos interpretari?
\lnr{25}Sed fallitur Diodorus.
\lnr{26}Nam \textgreek{[Greek]}, quae illius temporibus obtinebat, erat
...
\textgreek{[Greek]} (Apollinem) \textgreek{[Greek]}.
\lnr{34}Huius meminit et Aelianus libro decimo.
\lnr{34}Nunc quid
velit Manilius per te ipse potes intelligere.
\lnr{35}Ait Metonem coelum
versasse in novum orbem, hoc est, conversionem mundi \textgreek{[Greek]}
novo orbe et nova periodo \textgreek{[Greek]} definivisse[?], cum
...
numerum aureum vocamus, dininiunt.
...
% à ->ab
ex octaeteridibus Cleostrati et Harpali, tempora sua ordiebatur,
...
% à ->ab
\lnr{23}Unde
ipsum organon \textgreek{[Greek]} vocarunt Graeci, a silstitii observatione.
...
interpretem Aristophanis \textgreek{[Greek]},
 instar \textgreek{[Greek]} Pherecydis, quod
...
\lnr{32}Philochorus de Heliotropii positu: sed de tempore refragatur.
\lnr{33}Philochorus enim
censebat Metonem ante Pythodorum Archontem Heliotropium
posuisse.
\lnr{35}Ipse post Pythodori magistratum aut faltem in magistratu
ipso, non autem ante magistratum, positum contendit.
\lnr{36}Verba
Grammatici de Metone haec sunt: \textgreek{[Greek]}.
\lnr{39}Lege: \textgreek{[Greek]}.

...
Heliotropium statuisse credaus, optimi scriptoris auctoritate
moti.
\lnr{7}Sed de Solstitio cur dubitem, cum auctorem lucopletem
...
\begin{quote}
  ...
  \emph{Inseditque animis. Tenuit rem Graecia sclers}\\
  \emph{Protinus, et longos inventam misis in annos.}\\
...
Hecatombaeonis Metonici \textgreek{[Greek]}.
\lnr{28}Diodorus
libro duodecimo: \textgreek{[Greek]}.
\lnr{32}Proinde \textgreek{[Greek]} observatum Solstitium
a Metone.
\lnr{33}Et proximo \textgreek{[Greek]} Hecatombaeone Pythodorus
innivit magistratum, novem mensibus ante initia belli Peloponesiaci.
...
\lnr{37}Quare mirari satis[?] non possum, cur Columella dixerit, se, autctore
Metone, solstitium in octava parte Cancri, sicut alia \textgreek{[Greek]}
...
scribit Censorinus: \emph{Praeterea sunt anni magni comptures: ut Metonicus,
quem Meton Atheniensis ex annis undeviginti constituit.}
\lnr{4}\emph{Eoque
Enneadecaeteris appellatur: et intercalatur septies: in eoque
anno sund dierum sex millia, et quadrigenti quadraginta.}
\lnr{6}Legendum:
...
\lnr{8}Nam ex notis vulgaribus fluxit error, dierum sex millia,
 et \textsc{ccccxl}.
\lnr{9}Deest enim \textsc{id}[?] nota quingentorum.
...
temporis.
\lnr{17}Cum autem periodus ipsa 6940 diebus praecise explicartur,
in illis erant anni Lunares \textsc{xix}, menses \textgreek{[Greek]} septem,
dies quatuor, scrupula nulla.
\lnr{19}Quare propter illos quatuor dies abundantes,
quatuor quoque anni erant \textgreek{[Greek]}, dierum scilicet
...
\lnr{6}Unde eam \textgreek{[Greek]} vocavit.
\lnr{6}Si igitur omnes
menses 235 huius periodi essent \textgreek{[Greek]}, et pleni, ii fierent
dies 7050.
\lnr{8}De quibus si detrahantur dies 6940, quantitas nempe
huius periodi, relinquentur menses cavi 110, qui debentur
huic periodo: et proinde reliqui 225 erunt pleni.
\lnr{10}Longe igitur
...
syzygias et dies 4 1/11, utendum erit \textgreek{[Greek]},
...
\textgreek{[Greek]}, donec ultima syzygia sit cava, et pro eius tricesima,
...
\lnr{23}Nam Cella, quae habet tres nomeros, ea indicat mensem cavum.
...
loquuntur pro \textgreek{[Greek]}, \textgreek{[Greek]}.
\lnr{26}Ideo mensis
est cavus.
\lnr{27}Inferior autem numerus est feria, vel character neomeniae.
\lnr{28}Quaecunque qutem neomeniae habent unum numerum, eae
sunt plenorum mensium.
\lnr{29}Reliqua facilia sunt.
\lnr{29}Ex quibus vides
\textgreek{[Greek]} non fieri in uno die,
 sed prout coniugatio duarum syzygiarum
postulat.
\lnr{31}Post binas enim syzygias fit \textgreek{[Greek]}, donec numerus
...
continentur sexagesies ter, propterea cinses Metonem statim
post 63 dies \textgreek{[Greek]} fecisse.

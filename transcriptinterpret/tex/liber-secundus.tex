...
ante aequinoctium.
\lnr{8}Quae diversitas contigebat ex embolismis,
...
in \rnum{xix} annis Iudainis fieri.
\lnr{31}Non
...
ut non solum opsae cyclos sibi similes instituerint, sed et si quando
...
\rnum{x}.
\lnr{35}Arabes vocant \textarabic{[Arabic]} \textgreek{Επακταὶ[?]} dictae ideo,
 quod ut Luna Solem
...
\lnr{40}Longe enim posterior illares[?], % ink spot between 'a' and 'e'
 quam cyclus.
...
pulicavit: quod ex \rnum{xlii} capite Bedae de ratione temporum
constat.
%
% Table p156
...
\plnr{240}{157}{2}Victorinus in prologo suae magnae periodi ita scribebat:
 \textit{Latini
a \rnum{iii} Nonarum Martiarum, ad \rnum{iii} Nonas Apriles, diebus scilicet

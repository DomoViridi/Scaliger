...
(intelligit Metonem et Calippum)
\textgreek{[Greek]}
\lnr{11}\textgreek{[Greek]}.
\lnr{14}Malim legere
\textgreek{[Greek]}, potius quam \textgreek{[Greek]}
 $\overline\tau$ \textgreek{[Greek]}.
\lnr{15}Neque aliter scripsit Hipparchus.
\lnr{15}Sed
in ratione \textgreek{[Greek]} ipse et
...
\lnr{27}Duc igitur Hipparchae constat
...
funt etiam, ut dixi, quindecim \textgreek{[Greek]},
 id est, quorum \textgreek{[Greek]}
est plenus, vel uterque Scirrhophorion est plenus, si est annus
embolimaeus.
\lnr{34}Annus autem ultimus, sive 76, est \textgreek{[Greek]}.
\lnr{34}Igitur
cum periodus Hipparchea constet ex quatuor periodis Calippicis, debet
habere quater quindecim annos \textgreek{[Greek]}.
\lnr{36}Sed ultimus annus,
hoc est trecentesimus quartus, non erit \textgreek{[Greek]}.
\lnr{37}Et ita in periodo
Hipparchea sunt anni \textgreek{[Greek]} undesexaginta.
...
Calippicae non fuerit \textgreek{[Greek]}, ut in prioribus tribus, sed dierum
duntaxat 354.
...
\textgreek{[Greek]} Pyanepsionis Metonici, Calippici, et veri.
\lnr{18}Edidit et
ipse Hipparchus hanc periodum cum parapegmate, ex quo Plinius,
et Columella \textgreek{[Greek]} non raro producunt.
...
Elmagarin.
\lnr{3}Et fortasse inde Graecis recentioribus \textgreek{[Greek]}
 pro \textgreek{[Greek]},
et \textgreek{[Greek]} pro \textgreek{[Greek]}.
\lnr{4}Sed dubitari potest.
\lnr{4}Nam
\textgreek{[Greek]} hodie in idiotismo Graeco est Macula, \textgreek{[Greek]}.
\lnr{5}At aliud
...
Essarak, hoc est \textgreek{[Greek]}, ut vere sunt.
...
principes sive \textgreek{[Greek]} Aretae dicti, ut Aegyptiorum Ptolemaei.
\lnr{16}Usi
...
\lnr{21}Sed in
prima intercalatione mensis tertius itidem erat primus anni: quae quidem

...
a Pyanepsione, \rnum{vi} Octobris, quae erat
 \textgreek{[?]} Boedromionis Tetraeterici
...
\lnr{16}In qua nihil puto innovatum praeter menses Mecedonum, cum
...
in Virgine sito.
\lnr{23}Anno 55 periodi secundae, Nabonassari 548, Mechir 9,
...
\lnr{4}Anno 54 periodi Calippi Assicae, Hecatombaeon fuit 12 Iulii, in litera
D.
...
Eclipsis \rnum{xv} Elaphebolionis, aut Distri in anno 54 Attico, 55
Macedonico.
...
observatis, id est, quod Syromecedones duplici anno uterentur, mesium
\textgreek{[?]} et Lunarium, ut solebant Attici, praeter alia, quae firmandae
opinionis adducere poteramus, fidem fecerit locuples testis Iosephus,
qui ita scribit \textgreek{[?]}.
\lnr{27}Dixit Hyperberetaeum
\textgreek{[?]}, quia erat \textgreek{[?]}.
\lnr{29}Ita etiam Thycydides dixit \textgreek{[?]},
quia scilicet alia erat \textgreek{[?]}, utpote tetraeterica mensis
\textgreek{[?]}.
...
\subsection{De Periodo Syromaecdonum Alexandrea}
...
procedet, donec ex excessu scrupulorum 94- supra diem unum,
componatur dies solidus, qui faciat annum communem \textgreek{[Greek]}
...
plenis, cum appendice bidui, quas \textgreek{[Greek]} vocabant.
\lnr{20}Et cum
...
Tetraetericos.
\lnr{25}Erat autem et alius annus mere Lunaris, quem \textgreek{[Greek]}
...
\lnr{31}Iam alibi diximus Hyperberetaeum aequabilem traductum ae[?]
...
in coitu luminarium neomeniae[?] Ab Iudaici 3449, cuius character 2.5.812,

...
% Delayed page start
\setcounter{pdfpagenr}{156}%
\setcounter{sourcepagenr}{73}%
...
\begin{verse}
-- \textit{tenuit rem Graecia solers}\\
\textit{Protinus, et longos inventam misit in annos.}
\end{verse}
...
% 96
% {PDF page nr}{source page nr}{line nr}
\setcounter{pdfpagenr}{179}%
\setcounter{sourcepagenr}{96}%

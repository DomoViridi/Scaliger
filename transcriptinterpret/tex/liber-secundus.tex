...
\subsection{De periodo Chaldaeorum Alexandrea}
...
\subsection{De periodo Hipparchi et vero anno lunari}
...
μιᾶς ἡμέρας[?]}.
\lnr{11}\textgreek{ὡς ἐν τοῖς[?]} $\overline\tau$
 \textgreek{ἔτεσιν ἐλλείπειν παρὰ
μὲν τὸν Μέτωνα ἡμέρασ πέντε, παρὰ δὲ
τὸν Κάλιππον ἡμέραν μίαν[?]}.
\lnr{14}Malim legere
\textgreek{ἐν[?]} $\overline{\tau\delta}$
 \textgreek{ἔτεσιν[?]},
potius quam \textgreek{ἐν[?]}
 $\overline\tau$ \textgreek{ἔτεσιν[?]}.
...
\subsection{De periodo Arabum Hagarenorum}
% Table p110
\begin{table}[htbp]
...
\subsection{De periodo Samaritanorum}
...
\subsection{De anno Arabico soluto epochae Iulianae}
...
anno 1565 in quadam epistola sua ex insula Iapan ita scribit: Incidie
...
Arabici 983, feria septima, Augusti \rnum{vi}, propterea \rnum{xx} Augusti fuit
...
Kalndas, feria \rnum{v}, praecessit feriam Regeb Arabici die uno, in anno
Hegitae 972.
\lnr{25}Nicolaus Crontius Venetus in Iternario suo scribebat, qui
erat Christi 1400, eum fuisse dicit secundum Indos 1490.
\lnr{27}Sane anno
1400 caepit annus Hegirae 803, Augusti \rnum{xxii}, feria prima.
\lnr{28}Differentia
igitur Hegirae, et annorum Indocorum, 687: qui anni simplices Lunares,
...
\lnr{37}Erat annus Seleucidarum 268, a Septembri, et prionde 38 periodi
...
\lnr{3}Atque haec
est, sine dubio epoche Indorum ab Hagarenis acccepta.
...
biduo.
\lnr{22}Iam enim agitur annus Indorum 1690: qui ausert diem
...
eadem sunt utriusque ratiocinia in ferairum doctrina.
\lnr{25}Experiamur
igitur.
...
unus.
\lnr{40}Ita tres numari sunt, qui datam summam conficiunt 456, 209, 1.

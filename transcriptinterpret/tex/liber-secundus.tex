...
\begin{table}[htbp]
 \input{./tables/065-octaeteris-cleostrati-w}
\end{table}
%
\lnr{17}Scripta est
...
% Table: ΜΗΝΕΣ ΚΟΙΛΟΙ
\begin{table}[htb]
 \input{./tables/067a-menes-koiloi}
\end{table}
%
% Table: ΝΕΟΜΗΝΙΑΙ ΤΗΣ ΟΚΤΑΕΤΗΡΙΔΟΣ
\begin{table}[htb]
 \input{./tables/067b-neomeniai-tes-oktaeteridos}
\end{table}
%
% 67
% {PDF page nr}{source page nr}{line nr}
...
\begin{table}[htbp]
\input{tables/079a-characterismi-neomeniarum.tex}
\end{table}
% Tabella Characterismi periodorum
\begin{table}[htbp]
\input{tables/079b-characterismi-periodorum.tex}
\end{table}
% Tabula neomeniarum metonicarum in mensibus iulianis
\begin{table}[htbp]
\input{tables/080-neomeniarum-metonicarum.tex}
%%
\end{table}
%
% 79
...
\begin{table}[htb]
 \input{./tables/082-linea-metaptoseos-metonicae}
\end{table}
%
\lnr{30}Exemplum.
\lnr{30}Anno Christi
...
\begin{table}[btp]
 \input{./tables/084a-menses-tetraeterici}
\end{table}
%
% Table: Cyclus Metonis Philippeus
\begin{table}[t]
 \input{./tables/084b-cyclus-metonis-philippeus}
\end{table}
%
...
\begin{table}[htbp]
 \input{./tables/087-characteris-periodorum-calippi}
\end{table}
%
...
\input{tables/089-neomeniarum-periodi-calippicae.tex}
...
% Table
\begin{table}[htbp]
  \input{tables/091-menses-macedonici-attici.tex}
\end{table}
%
...
\begin{table}[htbp]
  ...
  \begin{tabular}{c c}
    \begin{minipage}[][0.44\linewidth][t]{0.4\linewidth}
      \input{tables/095a-menses-syrorum.tex}
    \end{minipage}
&
    \begin{minipage}[][0.44\linewidth][t]{0.4\linewidth}
      \input{tables/095b-characterismi-periodorum-syriacarum.tex}
    \end{minipage} \\
...
\begin{table}[htbp]
 \input{tables/096-periodi-syrorum.tex}
\end{table}
%
...
% Table
\begin{table}[htbp]
 \input{tables/099-menses-chaldaei.tex}
\end{table}
%
% 99
% {PDF page nr}{source page nr}{line nr}
...
\begin{table}[tb]
  \input{tables/101-nomina-annorum-schaichun.tex}
\end{table}
%
% 102
% {PDF page nr}{source page nr}{line nr}
...
\begin{table}[t]
  \centering
  \input{tables/105-mensium-iudaicorum.tex}
\end{table}
%
...
% Table p109
\begin{table}[t]
  \input{tables/109-hyparchi-calippi-metonis.tex}
\end{table}
%
...
% Table p110
\begin{table}[htbp]
  \input{tables/110-periodo-hagarena.tex}
\end{table}
%
\lnr{21}Quemadmodum
ex periodo Olympica
...
% Table p121
\begin{table}[t]
  \input{tables/121t-anni-menses-arabici.tex}
\end{table}
...
% Tabula
% Blank line required before longtable, or preceding text is deformed.
  \input{tables/127-noviluniorum-tisri.tex}
%

\begin{table}[tp]
  \input{tables/129a-annorum-collectorum.tex}
\end{table}

\begin{table}[tp]
  \input{tables/129b-epactarum-tisri.tex}
\end{table}
...
% Table
\begin{table}[t]
  \input{tables/132-characterum-tisri.tex}
\end{table}
...
% Table
\begin{table}[t]
  \input{tables/133-neomeniae-mensium.tex}
\end{table}
\lnr{33}Nam periodus
...
% Table
\begin{table}[t]
\input{tables/134-veterum-hebraeorum.tex}
\end{table}
...
% Table p138
\begin{table}[tp]
\input{tables/138-menses-hegirae.tex}
\end{table}
%
% 138
% {PDF page nr}{source page nr}{line nr}
...
%  \setlength{\tabcolsep}{0.0ex}
  ...
  \begin{tabular}{l @{\hspace{0.05\textwidth}} r}
    \begin{minipage}[][\tabh][t]{0.65\textwidth}
      \input{tables/139a-periodi-arabicae.tex}
    \end{minipage}
&
    \begin{minipage}[][\tabh][t]{0.27\textwidth}
      \input{tables/139b-characterismi-periodi.tex}
    \end{minipage} \\
    \addlinespace[0.85in] % force a lot of space to make room for the captions
  \end{tabular}
\end{table}
...
% Table p140
\begin{table}[htbp]
  \input{tables/140-neomeniae-muharram.tex}
\end{table}
%
...
\begin{table}[tbp]
  \input{tables/141a-redigendi-annos-arabicos.tex}
\end{table}
% Table p141b: Tabula annorum expansorum
\begin{table}[tbp]
  \input{tables/141b-annorum-expansorum.tex}
\end{table}
...
% Table p142
\begin{table}[tbp]
  \input{tables/142-conferendi-neomeniam-tisri.tex}
\end{table}
\lnr{37}Annus
hic agitur Christi
1594, Iudaicus 5355,
...
\begin{table}[tbp]
  \input{tables/147-characterismi-muharram.tex}
\end{table}
%
\lnr{15}Hoc
...
\begin{table}[tb]
  \centering
  \input{tables/153-heccaedecaterris-paschalis.tex}
...
% Table p154
\begin{table}[tb]
  \input{tables/154-paschali-alexandrinorum.tex}
\end{table}
%
\lnr{14}Itaque
...
% Table p156
\begin{table}[tb]
  \input{tables/156-paschali-occidentalium.tex}
\end{table}
%
...
\begin{table}[tb]
  \input{tables/158-elenchus-theophili.tex}
\end{table}
%
\lnr{25}Tandem
...
\begin{table}[tb]
  \input{tables/162-termini-paschalis.tex}
\end{table}
%
\lnr{1}Magnus igitur
...
% Table p164
\begin{table}[tb]
  \input{tables/164-cycli-paschalis-dionysiani.tex}
\end{table}
%
...
% Table p169
\begin{table}[tb]
  \input{tables/169-menses-saxonum-danorum.tex}
\end{table}
%
...
% Table p171
\begin{table}[tb]
  \input{tables/171-menses-pervanorum.tex}
\end{table}
%
...
% Table p175
\begin{table}[tb]
  \input{tables/175-menses-romani.tex}
\end{table}
%
...
% Table p179
\begin{table}[tbp]
  \input{tables/179-anni-romani.tex}
\end{table}
%
% 179
% {PDF page nr}{source page nr}{line nr}
...
% Table p183
\begin{table}[tb]
  \input{tables/183-saeculi-romani.tex}
\end{table}
%

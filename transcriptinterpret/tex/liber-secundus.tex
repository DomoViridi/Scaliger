...
cum characterismo feriae Nisan composita in anno Embolimao defectivo
...
quae e illo petas licet: idque accidisse, quo tempore Pascha, hoc est,
...
\lnr{40}Tisri Kal. % Abriv.
 Septembris,
Sabbato, cyclo Solis 17.
\lnr{41}Quare Neomenia Nisan in anno embolimaeo,
feria tertia, Martii \rnum{xxvi} at \textgreek{[Greek]} \rnum{viii} Aprilis,
...
\lnr{7}Hierosolyma capta a Pompeio fuisse \textgreek{[Greek]},
...
scriptor ex Nocolao Damasceno, ea, quae contigerunt Iudaeis et
eorum Ethnarchae Hyrcano, initio imperii Antiochi eius, qui \textgreek{[Greek]}
dictus est.
\lnr{30}Antiochus igitur \textgreek{[Greek]} obsedit Hyrcanum, anno primo
eius sacerdotii.
\lnr{31}Foedus deinde icit cum eo post \textgreek{[Greek]}.
\lnr{31}Hyrcanus
...
iter suscipere.
\lnr{36}Iudaeorum enim \textgreek{[Greek]}.
\lnr{37}Impetrat a Rege.
\lnr{37}Verba Damasceni: \textgreek{[Greek]}.
...
verba Damasceni subiicit: \textgreek{[Greek]}. \textgreek{[Greek]}.

% 108
% {PDF page nr}{source page nr}{line nr}
\plnr{191}{108}{2}Duo igitur festivi dies, Sabbatum et
Pentecoste.
...
178, Antiochus foedus inivit cum eo, solenni \textgreek{[Greek]}.
\lnr{10}Sequenti aestate, ut diximus, neomenia Sivvan incidit in feriam tertiam.
\lnr{12}Videamus, an peeriodus nostra hoc promittat.
...
\lnr{15}\textgreek{[Greek]} hodierna Iudaica
...
collatis, primus ex Graecis deprehendit \textgreek{[Greek]} cursus Lunaris intra
...
Calippi.
\lnr{32}Unde si intra \rnum{cc} annos \textgreek{[Greek]} duorum trientium fieri
solet, in \rnum{ccc} igitur fiet unius solidi diei.
\lnr{33}Quatuor aute periodi Calippicae
\rnum{ccciiii} annis explicantur.
\lnr{34}Quare si intra illud intervallum
quatuor periodorum \textgreek{[Greek]} sit, resoluendum erit illam quantitatem
temporis in tot syzygias, quot constant \rnum{xvi} cycli \textgreek{[Greek]},
...
3760 syzygias, fiet una syzygia dierum 29~\myfraq{359}{752}.
\lnr{2}Quae sunt, praeter dies
29, scrupula diei plusquam 31.'51.''42.'''7.'''' hoc est, horae 12.44.'41.''6.'''
\lnr{4}Cyclus autem Hipparchi erit dierum 6939~\myfraq{11}{16}.

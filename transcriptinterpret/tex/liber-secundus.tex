...
pertinere videntur.
\lnr{6}Ita enim libro \rnum{xvii} de Aegyptiis loquitur: \textgreek{[Greek]}
\textgreek{[Greek]}
\lnr{8}\textgreek{[Greek]}
\lnr{11}\textgreek{[Greek]}
\lnr{11}Ab Aegyptiis
et Chaldaeis accepisse quidem fateor, sed \textgreek{[Greek]}, ut vult
Strabo: id vero non ego, sed consuetudo ipsa Graecorum refellit.
\lnr{13}Nam
quo certo die \textgreek{[Greek]} fciebant designare,
 quomodo id poterant sine 365
dierum numero, et quadrantis praeterea accessione?
\lnr{15}Quare vetustissima
est haec \textgreek{[Greek]} de anni Solaris quantitate doctrina.
...
ut Solis \textgreek{[Greek]} cum illis Lunae congruant: cum hoc
...
deducere, ut nulli scrupuli, si fieri possit; sin alier, ut saltem quam
...
est ratio quatuor cyclorum, quam unius: imo \textgreek{[Greek]} longe maior.
...
\lnr{16}Quae si essent omnes plenae, \textgreek{[Greek]}, essent dies 28200: de
...
abiectis septem, ubi opus erit, dabit characterem sive veriam neomeniae.
...
anticipata fit, cum vera neomenia Tamuz Iudaici 3431[?], cuius
...
\lnr{16}Quod ne fieret, relifiose cavebant
Attici.
...
autem circiter finem Decembris, quod quidem contigere debebat,
...
neomenia competebat diei 22 Ianuarii: anno autem sequente, enmpe
...
anni solstitialis Atheniensium, et \textgreek{[Greek]}?
...
in Laterculo, componecum 4 charactere Pyanepsionis.
...
spica Virginis coniunctam, \textgreek{[Greek]} $\overline\rho$,
anno primae periodi Calippicae 48,
\textgreek{[Greek]} $\overline\varsigma$ \textgreek{[Greek]}.

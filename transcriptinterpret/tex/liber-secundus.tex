...
% Last line in section attached to the section, no paragraph break.
% 
% 69
% {PDF page nr}{source page nr}{line nr}
...
exacae sint.
\lnr{6}Quas quidem sex horas ipsi non nomerant, ut supra diserte
explicatum est.
...
\lnr{9}A ro[?]ridie enim esset 6.13.804,
% ink blob
...
trium differentia sunt dies 3 defectivi: aut 4, aequabilis: aut 5, abundantis.
\lnr{33}Embolimaei characteres sunt 5, 6, 7.
\lnr{33}Exempl. % Abbriv.
...
abundans.
\lnr{36}Uterque enimest communis, cum alter sit primus
...
quia Tisri nunquam incipit feria prima, transfetur,
...
\lnr{19}Qui habet Marchesvvan
solidum.
\lnr{20}Quis aequabilis?
\lnr{20}Qui habet Marchesvvan cavum,
Casleu solidum.
\lnr{21}Translationes igitur, \textgreek{καὶ ὑπερβάρεισ ἡμερῶν[?]} sunt causa
...
generis.
\lnr{40}Nam feria transfertur, aut comperendinatur \textgreek{[Greek]} tantum
...
nempe 4, 8, 876, ad 3, 9, 204 adiectis, confuget novilunium
...
quintam.
\lnr{12}Tertia caussa \textgreek{[Greek]},
 \texthebrew{[?]}[Hebrew], \textsc{batv
takphat} post embolismum.
\lnr{13}Cum siclicet annus, ui proxime embolismum
...
deducto.
\lnr{17}At iam dictum est 3, 18, 0, esse reiiculum tum \textgreek{[Greek]}, tum
\textgreek{[Greek]}.

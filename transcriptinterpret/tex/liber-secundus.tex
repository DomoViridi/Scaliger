...
\begin{quotation}
Novilunium \textsc{Elhagiathi} supra \rnum{x} hor. et dimidium, et decimam 
partem, a die \rnum{ii}, \rnum{iii} in \rnum{vi}. \textsc{Adar} 
\hfill \rnum{v}.~\rnum{xxxi}

Novilunium \textsc{Muharram} supra \rnum{iii} hor. et dimidium, et decimam 
partem a nocte \rnum{iiii} in \textsc{Pesach} \rnum{vi} \textsc{Nisan} 
\hfill \rnum{i}.~\rnum{xxx}

Novilunium \textsc{Tzephar} supra \rnum{vi} hor. et trientem et decimam 
partem a nocte \rnum{iiii} \textsc{Iiar} 
\hfill \rnum{v}.~\rnum{xxxi}

Novilunium \textsc{Rabie} supra \rnum{x} hor. et tricesimam partem decimae, 
a nocte \rnum{vii}, \rnum{i}, in \rnum{iii} \textsc{Sebin} 
\hfill \rnum{vi}.~\rnum{xxx}

Novilunium \textsc{Rabie} supra \rnum{xi} hor. et tricesimam partem quintae, 
a nocte \rnum{ii} in \rnum{ii} \textsc{Thamuz} 
\hfill \rnum{i}.~\rnum{xxxi}

Novilunium \textsc{Giumadi} supra \rnum{xi} hor. et dimidiam et tricesimam 
...
%
\begin{center}
\large\textsc{Neomeniae septimi} (anni) \textsc{in Semita.} \texthebrew{אהרר}[?]\\
\end{center}

\begin{quotation}
Novilunium \textsc{Giumadi} supra \rnum{ix} hor. et tricesimam partem,
a nocte \rnum{v}, \rnum{xxx} \textsc{Ab}
\hfill \rnum{iiii}.~\rnum{xxxi}

Novilunium \textsc{Regeb} supra \rnum{viii} hor. et trientem et tricesimam
partem quintae, a die \rnum{vi}, \rnum{vii} in solenni
\textgreek{σκηνοπηγιας[?]} \rnum{xxix} \textsc{Ilul}
\par
\hfill \rnum{vii}.~\rnum{xxx}.~\texthebrew{אהרר}[?]

Novilunium \textsc{Sahaben} supra \rnum{v} hor. et tricesimam quintae,
...
Novilunium \textsc{Scewal} supra \rnum{v} hor. et tricesimam decimae,
a nocte \rnum{iiii}, in \rnum{xxvii} \textsc{Caslim}
\hfill \rnum{vii}.~\rnum{xxxi}

Novilunium \textsc{Elkaidathi}, supra \rnum{ii} hor. et tricesimam
...
mense, causa in promptu est: quia videlicet \textgreek{σκηνοπηγία[?]}
 nunc in Ilul,
nunc in tisri incidit ut in illo anno 1584 Christi
...
quemadmodum Nisan dicitur \texthebrew{[?]}[Hebrew] quod ille memsis proprius
...
Diem, altera Noctem.
\lnr{11}Itaque prima neomenia fuit feria fecunda, sequente

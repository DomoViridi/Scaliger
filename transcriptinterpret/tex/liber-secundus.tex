...
cunveniebat in decimum, non in octavum, ut vult Dyonysius.
\lnr{7}Rursus
...
\textgreek{φύσει[?]}.
\lnr{17}Sed quia prima enneadecaeteris Chistiana caepit ab initio Diocletiani,
...
Ianuarii collectorum, abiectis omnibus tircenariis, reliquum pro termino
...
\rnum{xvi} Luna, et in secundam feriam prima.
...
\lnr{19}In cuius versu primo posuimus fulum cycli Paschalis Dionysiani,
sive Eusebiani: in secundo
cyclum horum hominum,
quibus nullum nomen fecit anitquitas,
tantum eos vocans \textgreek{ἑξαπλούντας καὶ πενταπλούιτας[?]}.
...
dies a Kalen. % Abbriv.
 Ianuarii, ad terminum Paschalem usitatum collecti. % accent on u in usitatum?
\lnr{33}Sextus complectitur terminos Paschales illius cycli.
\lnr{33}Septimus et ultimus
cyclum Solis.
\lnr{34}In annis igitur cycli fui, 1, 2, 3, 4, 18, quartamdecimam colligunt
ex ratiociniis suis.
...
\lnr{16}Quod si
16 fuerit Dominoca, tunc transferunt in Dominicam sequentem: ut
...
\lnr{39}In quo vides eum sectum fuisse hanc ridiculam
 \textgreek{ἑχάπλωσιν καὶ πεντάπλωσιν[?]},

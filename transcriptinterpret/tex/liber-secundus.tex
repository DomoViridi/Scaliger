...
iter suscipere.
\lnr{36}Iudaeorum enim \textgreek{ἑορτὰς ἀνεκδημήτους, καὶ ἀνεξοδεύτους εἶναι[?]}.
...
\lnr{7}\textgreek{Ημεῖς δὲ μῆνας μὲν ὅλους ἑυρίσκομεν, περιεχομένους
...
% Tabula
% Blank line required before longtable, or preceding text is deformed.
  \input{tables/127_noviluniorum_tisri.tex}
%

\begin{table}[tp]
  \input{tables/129a_annorum_collectorum.tex}
\end{table}

\begin{table}[tp]
  \input{tables/129b_epactarum_tisri.tex}
\end{table}
...
% Table
\begin{table}[t]
  \input{tables/133_neomeniae_mensium.tex}
\end{table}
\lnr{33}Nam periodus
...
% Table
\begin{table}[t]
\input{tables/134_veterum_hebraeorum.tex}
\end{table}
...
%  \setlength{\tabcolsep}{0.0ex}
  ...
  \begin{tabular}{l @{\hspace{0.05\textwidth}} r}
    \begin{minipage}[][\tabh][t]{0.65\textwidth}
      \input{tables/139a_periodi_arabicae.tex}
    \end{minipage}
&
    \begin{minipage}[][\tabh][t]{0.27\textwidth}
      \input{tables/139b_characterismi_periodi.tex}
    \end{minipage} \\
    \addlinespace[0.85in] % force a lot of space to make room for the captions
  \end{tabular}
\end{table}
...
% Table p142
\begin{table}[tbp]
  \input{tables/142_conferendi_neomeniam_tisri.tex}
\end{table}
\lnr{37}Annus
hic agitur Christi
1594, Iudaicus 5355,
...
\begin{table}[tbp]
  \input{tables/147_characterismi_muharram.tex}
\end{table}
%
\lnr{15}Hoc
...
% Table p154
\begin{table}[tb]
  \input{tables/154_paschali_alexandrinorum.tex}
\end{table}
%
\lnr{14}Itaque
...
% Table p156
\begin{table}[tb]
  \input{tables/156_paschali_occidentalium.tex}
\end{table}
%
...
\begin{table}[tb]
  \input{tables/162_termini_paschalis.tex}
\end{table}
%
\lnr{1}Magnus igitur
...
% Table p169
\begin{table}[tb]
  \input{tables/169_menses_saxonum_danorum.tex}
\end{table}
%
...
\lnr{7}Rursus abiece 189 annos Urbis, post quod tempus proxime censemus
...
\lnr{19}Praeterea et illia extant huius rei argumenta
non levia.
...
Kal. Iuniis.
\lnr{29}Quo nomine dictae Kalendae farariae; quod hoc mense
...
celebrabantur, satis araguunt Sextilem mensem in tempus pendentis
...
\lnr{39}Suetonius,
Censorinus, Macrobius scribunt, Pntifices, ad quos intercalandi,
...
ex libidine sua intercalant, rem sibi mandatam vitiose trctasse.
%
% 185
% {PDF page nr}{source page nr}{line nr}
\plnr{268}{185}{4}Itaque ingens turbatio inde consecuta est in anno Romano,
adeo, ut neque messium seriae aestati, neque vindemiarum autumno competerent.
\lnr{6}Nam ex hac licentia omittendae aut celebrandae ex libidine
intercalationis, nunquam anni Romani raio constabat.
\lnr{7}Ideo Cicero
...
civitatum post \rnum{viii} Iulii inceperet, nunquam efficietur, ut plenilunium
Solstitiale in Solstitium incurrat.
\lnr{33}Sed quanta sides, et quatenus
Plutarcho in istis adhibenda, alibi dociemus.
\lnr{34}Alii dicunt mense
ultimo anni quarti Olympiadis 97 captam.
\lnr{35}Ergo \rnum{xv} Scirroporionis,
...
\lnr{4}Apud Catonem
quoque lex vini pendentis huismodi extat: \textit{Locus vinis ex}
...
Romanum in Septermbrem Iulianum, et Ianuarium in Decembrem
convenisse.
\lnr{13}Anno \textsc{a.u.c.} \rnum{lxi}, Manio Acilio Glabrione, Publio Cornelio
Scipione Nasica \textsc{coss.} defecit Sol a.d. \rnum{v} Eid. Quintil. % Abbriv.
 anno periodi
Iulianae 4524, \rnum{xiiii} Martii, feria \rnum{vi}. Ex a.d. Eid. Quint. ad
 exitum anni,
...
\lnr{36}Postremo idem scirbens ex a.d. \rnum{xvii} Kal. Iun. % Abbriv
 ait se aequinoctium
...
\lnr{40}\textit{Utiam idem
maneat Hortensius, sisquidem adhuc erat.}
...
difinunt in diem 154.
\lnr{6}Aequinoctiom Iulianum \rnum{xxv} Martii.
\lnr{6}Aufer
...
Solaris annus \rnum{xvii}) reliquunt dies 296, hoc est diem 23 Octobris.
...
cras erit}, hoc idem est cum eo Catalliano:
\begin{verse}
...
\lnr{24}Id est, utinam sudem sit,
ut quidem nunc est.
\lnr{25}Atque is erat anni Romani status, cum C. Caefar
ei manum admovit: qui ex Lunari non malo in pessimum a Numa,
aut alio rupie, et rustico deprevatus, vitio intercalationis, veteres

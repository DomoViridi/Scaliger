...
in 28 Iunii.
\lnr{7}Itaque finis anni Solaris Syromacedonum incidebat in \rnum{vii}
Octobris, ibique intercalatio fiebat.
\lnr{8}Eorumque annus pupularis nunquam
...
\lnr{12}Iudae quoque anni illius solaris vestigia servent.
\lnr{12}Sed haec ita fuerint,
siquidem Clippi annum Tetraetericum reformatum sequamur.
\lnr{13}Alioquin
...
relinquunt dies 855.
\lnr{27}Qui sunt vingiti octo menses pleni embolimaei,
et quindecim dies praeterea:
 qui quidem dies annos totidem \textgreek{ὑπερημέρους[?]}
faciunt: qui ex progressu syzygiarum, it est ex compositione dierum
...
secundo Mecabaeorum anno 148 Seleucidarum (qui tamen vere 150
...
\lnr{17}Alexandtrum enim \textgreek{δικέρωτα[?]} vocante: quod ita sculperetur
...
Hyperberetaei aequabilis, id est propter
 \textgreek{κέντρον μετοπωρινὸν[?]} in \rnum{vil}
Octobris fixum.

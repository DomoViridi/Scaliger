...
\dropcap{V}{eteribus} statim ab initio has= diei partes=, quas= H O R A S vocamus=, in vsu non fuisse, argumento fuerint priscæ locutiones=, \mletter{B} quibus= dies= non in partes= secatur, sed actionibus= quotidianis= distiguitur: vt cum [Greek] vesperam vocabant, nimirum, vt poëta inquit, Demeret emeritis= cum iuga Phœbus= equis=.

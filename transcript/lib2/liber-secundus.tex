...
%    038-neomenia-elidensis it might be "Neomenia 1. mensis" or similar.
\begin{table}[htbp]
 \input{lib2/tables/065-octaeteris-cleostrati-w}
\end{table}
%
\lnr{17}Scripta est
...
% Table: ΜΗΝΕΣ ΚΟΙΛΟΙ
\begin{table}[htb]
 \input{lib2/tables/067a-menes-koiloi}
\end{table}
%
% Table: ΝΕΟΜΗΝΙΑΙ ΤΗΣ ΟΚΤΑΕΤΗΡΙΔΟΣ
\begin{table}[htb]
 \input{lib2/tables/067b-neomeniai-tes-oktaeteridos}
\end{table}
%
% 67
% {PDF page nr}{source page nr}{line nr}
...
\begin{table}[htbp]
\input{lib2/tables/079a-characterismi-neomeniarum.tex}
\end{table}
% Tabella Characterismi periodorum
\begin{table}[htbp]
\input{lib2/tables/079b-characterismi-periodorum.tex}
\end{table}
% Tabula neomeniarum metonicarum in mensibus iulianis
\begin{table}[htbp]
\input{lib2/tables/080-neomeniarum-metonicarum.tex}
%%
\end{table}
%
% 79
...
\begin{table}[htb]
 \input{lib2/tables/082-linea-metaptoseos-metonicae}
\end{table}
%
\lnr{30}Exemplum.
\lnr{30}Anno Christi
...
\begin{table}[btp]
 \input{lib2/tables/084a-menses-tetraeterici}
\end{table}
%
% Table: Cyclus Metonis Philippeus
\begin{table}[t]
 \input{lib2/tables/084b-cyclus-metonis-philippeus}
\end{table}
%
...
Calippi.
% Table 087-characteris-periodorum-calippi
\begin{table}[htbp]
 \input{lib2/tables/087-characteris-periodorum-calippi}
\end{table}
%
...
\input{lib2/tables/089-neomeniarum-periodi-calippicae.tex}
...
% Table
\begin{table}[htbp]
  \input{lib2/tables/091-menses-macedonici-attici.tex}
\end{table}
%
...
\begin{table}[htbp]
  ...
  \begin{tabular}{c c}
    \begin{minipage}[][0.44\linewidth][t]{0.4\linewidth}
      \input{lib2/tables/095a-menses-syrorum.tex}
    \end{minipage}
&
    \begin{minipage}[][0.44\linewidth][t]{0.4\linewidth}
      \input{lib2/tables/095b-characterismi-periodorum-syriacarum.tex}
    \end{minipage} \\
...
\begin{table}[htbp]
 \input{lib2/tables/096-periodi-syrorum.tex}
\end{table}
%
...
% Table
\begin{table}[htbp]
 \input{lib2/tables/099-menses-chaldaei.tex}
\end{table}
%
% 99
% {PDF page nr}{source page nr}{line nr}
...
\begin{table}[tb]
  \input{lib2/tables/101-nomina-annorum-schaichun.tex}
\end{table}
%
% 102
% {PDF page nr}{source page nr}{line nr}
...
\begin{table}[t]
  \centering
  \input{lib2/tables/105-mensium-iudaicorum.tex}
\end{table}
%
...
% Table p109
\begin{table}[t]
  \input{lib2/tables/109-hyparchi-calippi-metonis.tex}
\end{table}
%
...
% Table p110
\begin{table}[htbp]
  \input{lib2/tables/110-periodo-hagarena.tex}
\end{table}
%
\lnr{21}Quemadmodum
ex periodo Olympica
...
% Table p112-113
\bigskip % Avoid longtable bug
\input{lib2/tables/112-periodi-magnae-hagarenorum.tex}
%
% 113
% {PDF page nr}{source page nr}{line nr}
...
% Table p117
\begin{table}[btp]
  \input{lib2/tables/117-noviluniorum-samaritanorum.tex}
\end{table}
%
% 117
% {PDF page nr}{source page nr}{line nr}
...
% Table p121
\begin{table}[t]
  \input{lib2/tables/121t-anni-menses-arabici.tex}
\end{table}
...
% Tabula
% Blank line required before longtable, or preceding text is deformed.
  \input{lib2/tables/127-noviluniorum-tisri.tex}
%

\begin{table}[tp]
  \input{lib2/tables/129a-annorum-collectorum.tex}
\end{table}

\begin{table}[tp]
  \input{lib2/tables/129b-epactarum-tisri.tex}
\end{table}
...
% Table
\begin{table}[t]
  \input{lib2/tables/132-characterum-tisri.tex}
\end{table}
...
% Table
\begin{table}[t]
  \input{lib2/tables/133-neomeniae-mensium.tex}
\end{table}
\lnr{33}Nam periodus
...
% Suppress Underfull vbox warning by allowing vertical space at the bottom
% of the page.
\vspace*{\fill}
%
%====
...
% Table
\begin{table}[t]
\input{lib2/tables/134-veterum-hebraeorum.tex}
\end{table}
...
% Table p138
\begin{table}[tp]
\input{lib2/tables/138-menses-hegirae.tex}
\end{table}
%
% 138
% {PDF page nr}{source page nr}{line nr}
...
%  \setlength{\tabcolsep}{0.0ex}
  ...
  \begin{tabular}{l @{\hspace{0.05\textwidth}} r}
    \begin{minipage}[][\tabh][t]{0.65\textwidth}
      \input{lib2/tables/139a-periodi-arabicae.tex}
    \end{minipage}
&
    \begin{minipage}[][\tabh][t]{0.27\textwidth}
      \input{lib2/tables/139b-characterismi-periodi.tex}
    \end{minipage} \\
    \addlinespace[0.85in] % force a lot of space to make room for the captions
  \end{tabular}
\end{table}
...
% Table p140
\begin{table}[htbp]
  \input{lib2/tables/140-neomeniae-muharram.tex}
\end{table}
%
...
\begin{table}[tbp]
  \input{lib2/tables/141a-redigendi-annos-arabicos.tex}
\end{table}
% Table p141b: Tabula annorum expansorum
\begin{table}[tbp]
  \input{lib2/tables/141b-annorum-expansorum.tex}
\end{table}
...
% Table p142
\begin{table}[tbp]
  \input{lib2/tables/142-conferendi-neomeniam-tisri.tex}
\end{table}
\lnr{37}Annus
hic agitur Christi
1594, Iudaicus 5355,
...
\begin{table}[tbp]
  \input{lib2/tables/147-characterismi-muharram.tex}
\end{table}
%
\lnr{15}Hoc
...
\begin{table}[tb]
  \centering
  \input{lib2/tables/153-heccaedecaterris-paschalis.tex}
...
% Table p154
\begin{table}[tb]
  \input{lib2/tables/154-paschali-alexandrinorum.tex}
\end{table}
%
\lnr{14}Itaque
...
cyclum.
% Allow space at the end of the page to suppress Underfull vbox warning
\vspace*{\fill}
%
%====
...
% Table p156
\begin{table}[tb]
  \input{lib2/tables/156-paschali-occidentalium.tex}
\end{table}
%
...
\begin{table}[tb]
  \input{lib2/tables/158-elenchus-theophili.tex}
\end{table}
%
\lnr{25}Tandem
...
\begin{table}[tb]
  \input{lib2/tables/162-termini-paschalis.tex}
\end{table}
%
\lnr{1}Magnus igitur
...
% Table p164
\begin{table}[tb]
  \input{lib2/tables/164-cycli-paschalis-dionysiani.tex}
\end{table}
%
...
% Table p169
\begin{table}[tb]
  \input{lib2/tables/169-menses-saxonum-danorum.tex}
\end{table}
%
...
% Table p171
\begin{table}[tb]
  \input{lib2/tables/171-menses-pervanorum.tex}
\end{table}
%
...
% Table p175
\begin{table}[tb]
  \input{lib2/tables/175-menses-romani.tex}
\end{table}
%
...
% Table p179
\begin{table}[tbp]
  \input{lib2/tables/179-anni-romani.tex}
\end{table}
%
% 179
% {PDF page nr}{source page nr}{line nr}
...
% Table p183
\begin{table}[tb]
  \input{lib2/tables/183-saeculi-romani.tex}
\end{table}
%

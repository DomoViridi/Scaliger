...
%
\begin{table}[tb]
  \input{lib3/tables/219-iudaicae-neomeniae.tex}
\end{table}
%
...
\lnr{3}Iosephus etiam temporibus suis Sabbati
...
% Flavius Josephus, Jewish War; Book 4, line 582 (near the end of part IX)
% [582] ὁ δὲ λοιπὸς
% ὑπὲρ τὴν κορυφὴν κατεσκεύαστο
% τῶν παστοφορίων, ἔνθα τῶν ἱερέων εἷς ἐξ ἔθους ἱστάμενος ἑκάστην ἑβδομάδα
% εἰσιοῦσαν προεσήμαινε σάλπιγγι δείλης καὶ τελεσθεῖσαν αὖθις περὶ ἑσπέραν,
% ὅτε μὲν ἀνέργειαν τῷ λαῷ καταγγέλλων, ὅτε δ' ἔργων ἔχεσθαι.
\lnr{9}Quando
...
\lnr{12}Sed studiosi quaerant.
\lnr{12}Nam plura nobis
reperient.
\lnr{13}Tantum eam opinionem de solo usu anni Lunaris ex animis
hominum evellere poterimus.
% qui
\lnr{14}Qui etiam Noam in arca epactas
Lunares, et excessum Solis supra Lunam observasse divinant.
\lnr{15}Nunc
moniti nullas epactas invenient.
%
%====
\section{De novarum Indiarum Anno}
% Capitalisation follows ToC
%
%% Side-by-side tables
\begin{table}[tbh]
  % define table height
  \newcommand{\tabh}{0.61252\textheight} % 0.6118 - 0.61252
%  \setlength{\tabcolsep}{0.0ex}
  \centering
  \begin{tabular}{c @{\hspace{0.06\textwidth}} c}
    \begin{minipage}[][\tabh][t]{0.43\textwidth}
      \input{lib3/tables/224a-menses-mexicani.tex}
    \end{minipage}
&
    \begin{minipage}[][\tabh][t]{0.45\textwidth}
      \input{lib3/tables/224b-dierum-mexicani.tex}
    \end{minipage}
  \end{tabular}
\end{table}
%
\lnr{17}Non potuit opportuniore loco mentio iniici anni Mexicanorum,
et totius illius magnae Perusianae continentis, quam hic.
%% Tables: Menses Mexicani & Appellationes dierum mensis mexicani.
%
% 225
% {PDF page nr}{source page nr}{line nr}
\plnr{308}{225}{1}Nam habent aliquid commune cum aequalibi anno, ut pote cum
...
\lnr{4}Mensis vicenis diebus explicatur.
\lnr{5}Ita fiunt 360 dies.
% in
\lnr{5}In fine adiiciuntur \textgreek{ἐπαγόμεναι}[?] vitulationibus
et publicae laetitiae dicatae.
\lnr{6}Porro ut nos anni aliam divisionem
facimus, cum in septimanas tribuimus, ita illi per \rnum{xiii} dies distinguunt.
% neque
\lnr{8}Neque alium locum apud eos habet
 \textgreek{ἡ τρισκαιδεκαήμερος}[?], quam
apud nos \textgreek{ἡ ἑπταήμεροσ}[?],
 quae nunquam redit in orbem, nisi post quater
tredecim annos, qui sunt \rnum{lii}.
% quae
\lnr{10}Quae est eorum maxima Periodus.
% vel
\lnr{10}Vel
Salchodai constat quatuor minoribus, quarum singulae sunt tredecim
annorum.
\lnr{12}Prima vocatur Tochtli, Cuniculus.
\lnr{12}Secunda Acatlh,
Canna.
\lnr{13}Tertia Tecpatlh, Cochlear.
\lnr{13}Quarta Calli, Domus.
\lnr{13}Et vocant
primum, secundum, tertium, quartum annum periodi ita, Ce Tochtli,
ome Acatlh, Ei Tecpatlh, Navi Calli.
\lnr{15}Ut igitur Cuniculus,
...
\lnr{18}De hoc quoque anno intelligit Petrus
Martyr, cum scribit: \textit{Annum ab occasu heliaco Vergiliarum incipiunt,
et mensibus claudunt Lunaribus.}
\lnr{20}\textit{Mensem a Luna nominant
Tona.}
\lnr{21}\textit{Quum menses signare intendunt, Tonas inquiunt.}
\lnr{21}\textit{Lunam
eorum lingua Tonam dicunt.}
\lnr{22}\textit{Dies autem a Sole Tonaticos.}
\lnr{23}\textit{Unde quot Soles, tot Tonatici.}
\lnr{23}\textit{Eorum idiomate Sol Tonaticus dicitur.}
\lnr{24}\textit{Alicubi tamen aliter.}
\lnr{24}\textit{Sed nulla ratione moti annum distribuunt
in menses duodeviginti.}
\lnr{25}\textit{Menses autem etiam diebus viginti claudunt.}
\lnr{26}Quod iste Tonaticum vocat, Gomara \textsc{tonelli} dicit, et Tonelli
magnum vocat unam ex quatuor periodis minoribus, cuius primi
anni hecatombe captivorum.
\lnr{28}Maximus vero \textsc{tonellus} constans
ex \rnum{lii} annis fine anni ultimi multis Hecatombis celebrabatur.
\lnr{30}Quinque \textgreek{Επαγομένας}[?]
 cuiuslibet anni ebrietatibus dicant, ut diximus,
tanquam earum nulla ratio habenda sit in numero dierum anni.
\lnr{32}Habebant etiam rationem bisexti.
% quod
\lnr{32}Quod accurate observabant.
\lnr{33}Vides sensum huius anni ad illas gentes barbaras pervenisse.
\lnr{33}Plura
poteram dicere.
\lnr{34}Sed quae ad rem haec fere.
%
% 225
%
% Table "Mexican" calendar.

...
\lnr{6}Feria ergo 4 erit \textsc{F}. % Newline?
...
\lnr{9}Quod si nemerus annorum Nabonassari excesserit 228, tunc secunda
...
octagesimum sextum incurisse in a.d. \rnum{vii} Kalen. Iulias:
...
libro \rnum{v} statuit novilunium primi Thoth Nabonassari
 \textgreek{\gnum{κδ}. μδ'. ?ζ''}[?]. % Newline?
\lnr{12}Hoc est, Thoth \rnum{xxiiii}/. % Newline?
\lnr{12}Scrupulis diurnis 44', 17'', quae ad
...
erit Terminus secundi, et sic deinceps ascendo.
\lnr{17}Quibus
...
Chaldaicam: neque alio differunt, nisi quod epochen % Sic
 Nabonassari
implicitam habent.
%
% Two tables p203

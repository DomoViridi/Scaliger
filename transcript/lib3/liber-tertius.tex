...
%
%====
\section{De Neuruz Periodico Veterum Persarum}
%
...
variabat.
\lnr{20}Nam illae quinque appendices dies aliis aliam sedem hababant.
\lnr{21}Chaldaei, Porsae, Armenii, Aegyptii, unum, eundemque annum
norant.
...
\lnr{31}\textarabic{}[Arabic] enim illis est initium veris; quod ad
...
libro Indicarum rerum sexto, Cap. \rnum{xlvi}, scribit Lusitanorum
...
Praesectus, ut omnem apparatum solennitatis} \textsc{nevruz}, \textit{et
pompam retiam videret.}
\lnr{6}Haec ille.
...
\lnr{19}Nam quot
erant dies a neomenia Thoth primi, tot quaedriennia et annos Caniculares,
sive \textgreek{ἐνιαυτοὺς Θεοῦ}[?] putabant.
\lnr{21}Chaldaei vero et Persae, quia
singuli dies unius mensis appelationibus Heroum, aut regum cognominabantur,
primum quadriennium nomine diei primi vocabant:
secundum quadriennium, nomine secundi.
\lnr{24}Exemplum: Primi anni
magnae periodi, sive \textit{sal chodai}, caput in \textit{nevruz}, hoc est,

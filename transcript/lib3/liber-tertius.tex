...
post 360 dies reiectae: quas \textgreek{}[?] Graeci vocant, Aegyptii
...
et quinque magnis \textgreek{}[?], vel quinquies quater annis.
\lnr{12}Sed quod Cansorinus huiusmodi magnum annum \textgreek{}[?] vocari ait,
if verum est, si spectes neomeniam Thoth.
\lnr{13}QUoties enim neomenia
Thoth in ortum caniculae incidit, is dicitur recte \textgreek{}[?].
...
auctori credimus.
\lnr{27}Sed, inquies, nondum veteres illi \textgreek{}[?].
...
\lnr{37}Verba Dionis: \textgreek{}[?].
\lnr{40}Vide quot
errores.
\lnr{41}Ait \textgreek{}[?] embolismum bisexti fieri.
\lnr{41}Quod Graeco
...
bienniis exactis intercalare, dicit, \textgreek{}[?].
...
\lnr{26}An non plane \textgreek{}[?] omnium
...
Iuliano, ita \textgreek{}[?] in anno aequabili proxime ad praecisam
aequationem accdat.
\lnr{34}Enneadecaeteris Iuliana maiuscula est Lunari
hor.1,485.
\lnr{35}\textgreek{}[?]autem Aegyptica relinquit supra ratiocinia
Lunae, hor.1,123.
\lnr{36}Tanto praecisior est \textgreek{}[?] Enneadecaeteride.
...
quinquies hanc \textgreek{υπεροχιη}[?].

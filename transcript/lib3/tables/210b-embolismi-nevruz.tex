...
\addlinespace[5pt]
\multicolumn{2}{l}{%
 \parbox{\cwd}{\footnotesize\hspace{2ex}\textit{Wahac nova in }\rnum{xxvi}%
 \textit{ mensis Persici.}}%
}
%\multicolumn{2}{l}{\textit{Wahac sine Epogamena antiqua}} \\
%\multicolumn{2}{l}{\rnum{xxi}\textit{ Februarii.}} \\
%\multicolumn{2}{l}{\textit{Wahac nova in \rnum{xxvi} mensis Persici.}} \\
\end{tabular}
%

...
%
\begin{table}[p]
  \input{lib1/tables/006-convertendi-ostenta}
\end{table}
%
\lnr{14}Nam ante
...
% Insert table
\begin{table}[tbp]
  \input{lib1/tables/008-dies-hebdomadis}
\end{table}
...
\begin{figure}[tbp]
  ...
  {\astrofont\input{./img/008-planets-pdf.tex}}
...
\begin{figure}[t]
  \centering
  \includegraphics[scale=0.125]{011-lapis-lavinii}
...
\begin{table}[htbp]
  \input{lib1/tables/027-novilunia}
\end{table}
%
\lnr{26}Quia
...
\lnr{41}\textgreek{Αρχεται δ᾽ ἀνθεῖν μηνὸς Πυανεφιῶνος,
...
\begin{table}[htbp]
\input{lib1/tables/033-mensium-atticorum}
\end{table}
%
...
\begin{table}[htbp]
  \input{lib1/tables/034-neomeniarum-lunarium}
\end{table}
...
\begin{table}[htbp]
 \input{lib1/tables/038-neomenia-elidensis}
\end{table}
%
...
% Vertial filler to suppress Underfull vbox warning
%\vspace*{\fill}
%====
...
\lnr{24}\emd{} Quia scilicet priscus annus Atticus
ab bruma incipiebat.
% à -> ab
...
\input{lib1/tables/043-neomeniarum-atticarum}
%
% 44
% {PDF page nr}{source page nr}{line nr}
...
% Moved to earlier position, to avoid big whitespace end of previous page.
\begin{table}[hbtp]
  \input{lib1/tables/048-menses-macedonum}
\end{table}
\lnr{6}Cum
...
% Original position of table 048-menses-macedonum
...
\begin{table}[htbp]
  \input{lib1/tables/050a-menses-alexandreae}
\end{table}
...
\begin{table}[htbp]
  \input{lib1/tables/050b-menses-bithyniorum}
\end{table}
...
reliquarum regula.
% Suppress Underfull vbox message
\vspace*{\fill}
%====

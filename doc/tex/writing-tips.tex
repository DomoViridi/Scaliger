...
Latin and Greek.
\begin{itemize}
\item All ligatures are expanded (e.g. æ to ae).
...
Before the fancy stuff, the initial big work will be the actual transcribing,
i.e. reading from the scanned original and typing in the Latin text.

To correlate this transcript to the original, we intend to number the lines
in the PDF of the original.

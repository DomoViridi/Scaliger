...
%% Problem: only covers 1 paragraph. The next paragraph will be left-adjusted
%% to the margin again
\usepackage{type1cm}
\usepackage{lettrine}
%\usepackage{graphicx}
...
\newcommand\dropcapil[3]{%
    ...
    \lettrine[lines=#1,nindent=0pt,lraise=0.03]{#2}{#3}%
}
...
\newcommand\dropcap[3]{%
    ...
    \lettrine[lines=#1,nindent=0pt,lraise=0.1]{#2}{#3}%
}

%% Variables used by the dropcap command to calculate the scaling needed
...
%% Syntax: \dropcapw{lines}{initial}{caps}
\newcommand\dropcapw[3]{%
    \setlength{\DCunit}{1.4\baselineskip}%
    \setlength{\DCscale}{#1\DCunit}%
    \addtolength{\DCscale}{-0.5\DCunit}%
    \setlength{\columnsep}{30pt}\begin{wrapfigure}[#1]{l}{0mm}{\dropcapfont\fontsize{\DCscale}{1em}\selectfont #2}\end{wrapfigure}%
    \textsc{#3}%
}

%% Special version of the dropcap command for the letter Q
\newcommand\dropcapQ[2]{%
    \setlength{\DCunit}{1.1\baselineskip}%
    \setlength{\DCscale}{#1\DCunit}%
    \addtolength{\DCscale}{-0.5\DCunit}%
    \setlength{\columnsep}{1pt}\begin{wrapfigure}[#1]{l}{0mm}{\dropcapfont\fontsize{\DCscale}{1em}\selectfont Q}\end{wrapfigure}%
    \textsc{#2}%
}

...
Sic Martius primus erat \mletter{B} Romanorum:
...
Vt annus Solaris est cognominis circuitus eius \mletter{C} sideris,
...
Solis \& Lunæ, labentem cœlo qui ducunt annum, ratio in \mletter{D} temporibus
ciuilibus haberetur.
...
\mletter{B}qua ratione ab anno solari se minimum discedere arbitrati sunt.
...
\mletter{C}biduis, quas \textgreek{[Greek]} vocabant.
...
\mletter{D}Hipparchus, annis circiter centum octoginta octo ab epocha Calippica,
...
vtebantur Turcæ Cilices, donec annum Hegiræ simplicern \mletter{C}
...
Terminalia, \& Regisugium intercalabantur, vt vult Censorinus.\mletter{D}
...
At in Calippico \& Metonico anno aliquando citius, aliquando ferius\mletter{A}
...
definire non potuerunt. quippe Cleostratus dierum 2922, Harpalus\mletter{B}
...
Iudæis computatoribus\mletter{D}
...
\& habebant mensem desultorem\mletter{A}
...
diebus, refugiebant, quos necesse est retincri,
 quadrante illo retento.\mletter{B}
...
Nam \& Attici \& reliqui omnes Græci annum Solarem in\mletter{C}
...
obseruatio Græcis Astronomis, propter causam admodum futilem\mletter{A}
...
\mletter{B}vt fiat annus Solaris Himmarchus
...
sed hic annus comparatione Ægyptiaci\mletter{D}
...
\mletter{A}quem modo dixi, Galelæus.
...
ita vt eius statum post trecentos\mletter{C}
...
harmoniam in eorum orbibus ostendit esse, vt sequente\mletter{D}
...
Itaque \textgreek{[Greek]} nomine intelligendum ortus,
 \& occasus \textgreek{[Greek]},\mletter{A}
...
non tantum Solis \& Lunæ, sed etiam quinque errantium ad eandem\mletter{B}
...
Nam à caussis naturalibus,\mletter{C}
...
\mletter{D}Sed longe illa Sinarum prodigiosior, iuxta quam hic annus Christi
...
Sunt \& periodi Computatorum: vt Iudæa\mletter{A}
...
primum vtriusque cycli, pertinetque ad methodum Lunæ \& Solis.\mletter{B}
...
perduximus, \& eum in conspectu totius antiquitatis collocauimus.\mletter{C}
...
Secundum locum sibi vindicat annus\mletter{D}
...
interuallis, quæ sequentibus libris tractabimus, item diuersis\mletter{A}
...
Quis igitur sit vsus characteris temporum, docet nos
...
\mletter{C}vero certum non difiniunt.
...
\mletter{D}numerus 304. septem igitur dies neomeniis hodiernis adiiciendi.
